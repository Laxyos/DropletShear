...
#line 1 "/home/laxyos/basilisk/src/common.h"
#include <stdlib.h>
#include <stdio.h>
#include <stddef.h>
#include <stdbool.h>
...
#line 108 "/home/laxyos/basilisk/src/common.h"
...
static void * pmfunc_alloc (pmdata * d, size_t size,
       ...
       char c)
{
  if (!(d != NULL)) qassert ("/home/laxyos/basilisk/src/common.h", 183, "d != NULL");
  OMP (omp critical)
  {
...
{
  if (!(t->stack.len > 0)) qassert ("/home/laxyos/basilisk/src/common.h", 455, "t->stack.len > 0");
...
static void end_trace (const char * func, const char * file, int line)
{
  ...
  if (!(Trace.stack.len >= 2*sizeof(double))) qassert ("/home/laxyos/basilisk/src/common.h", 559, "Trace.stack.len >= 2*sizeof(double)");
...
#define prof_start(name)\
  if (!(!in_prof)) qassert ("/home/laxyos/basilisk/src/common.h", 669, "!in_prof"); in_prof = true;\
  prof_start = MPI_Wtime();\

#line 671

#define prof_stop()\
  if (!(in_prof)) qassert ("/home/laxyos/basilisk/src/common.h", 673, "in_prof"); in_prof = false;\
  _prof = MPI_Wtime();\
...
{ trace ("mpi_all_reduce0", "/home/laxyos/basilisk/src/common.h", 685);
  { int _ret =  MPI_Allreduce (sendbuf, recvbuf, count, datatype, op, comm); end_trace("mpi_all_reduce0", "/home/laxyos/basilisk/src/common.h", 686);  return _ret; }
 end_trace("mpi_all_reduce0", "/home/laxyos/basilisk/src/common.h", 687); }
#define mpi_all_reduce(v,type,op) {\
...
#line 828 "/home/laxyos/basilisk/src/common.h"
...
static void set_fpe (void) {
  ...
  if (!(sizeof (int64_t) == sizeof (double))) qassert ("/home/laxyos/basilisk/src/common.h", 838, "sizeof (int64_t) == sizeof (double)");
...
OMP(omp declare reduction (+ : coord :
      ...
      omp_out.y += omp_in.y,
      omp_out.z += omp_in.z))
#line 922 "/home/laxyos/basilisk/src/common.h"
...
#line 1 "/home/laxyos/basilisk/src/grid/boundaries.h"
...
#line 47 "/home/laxyos/basilisk/src/grid/boundaries.h"
typedef struct {
  Boundary parent;
  int d;
} BoxBoundary;
#line 1014 "/home/laxyos/basilisk/src/common.h"
...
#endif
#line 1017 "/home/laxyos/basilisk/src/common.h"
...
#line 1160
 {
      if (!(s->i >= 0)) qassert ("/home/laxyos/basilisk/src/common.h", 1161, "s->i >= 0");
      v.x = *s++;
    }
#line 1160
 {
...
#line 1191
 {
      if (!(v->x.i >= 0)) qassert ("/home/laxyos/basilisk/src/common.h", 1192, "v->x.i >= 0");
      t.x = *v++;
    }
#line 1191
 {
      if (!(v->y.i >= 0)) qassert ("/home/laxyos/basilisk/src/common.h", 1192, "v->x.i >= 0");
      t.y = *v++;
    }}
...
#line 1296 "/home/laxyos/basilisk/src/common.h"
...
#line 14 "shear_square-cpp.c"
#line 1 "grid/quadtree.h"
#line 1 "/home/laxyos/basilisk/src/grid/quadtree.h"


#line 1 "grid/tree.h"
#line 1 "/home/laxyos/basilisk/src/grid/tree.h"
#line 1 "grid/mempool.h"
#line 1 "/home/laxyos/basilisk/src/grid/mempool.h"
...
Mempool * mempool_new (size_t poolsize, size_t size)
{
  ...
  if (!(poolsize % 8 == 0)) qassert ("/home/laxyos/basilisk/src/grid/mempool.h", 26, "poolsize % 8 == 0");
  if (!(size >= sizeof(FreeBlock))) qassert ("/home/laxyos/basilisk/src/grid/mempool.h", 27, "size >= sizeof(FreeBlock)");
...
#line 2 "/home/laxyos/basilisk/src/grid/tree.h"




#line 1 "grid/memindex/range.h"
#line 1 "/home/laxyos/basilisk/src/grid/memindex/range.h"
#line 15 "/home/laxyos/basilisk/src/grid/memindex/range.h"
typedef struct {
  void ** p;
  int size;
} Memalloc;
...
#line 34 "/home/laxyos/basilisk/src/grid/memindex/range.h"
...
#line 73 "/home/laxyos/basilisk/src/grid/memindex/range.h"
 ...
 *m->p = (char *)(*m->p) - i*m->size;
    ...
    if (!(i > r->start && i < r->end)) qassert ("/home/laxyos/basilisk/src/grid/memindex/range.h", 108, "i > r->start && i < r->end");
    for (Memalloc * m = mem; m->p; m++)
...
#line 171 "/home/laxyos/basilisk/src/grid/memindex/range.h"
...
#line 218 "/home/laxyos/basilisk/src/grid/memindex/range.h"
...
#line 259 "/home/laxyos/basilisk/src/grid/memindex/range.h"
...
#line 305 "/home/laxyos/basilisk/src/grid/memindex/range.h"
...
#line 7 "/home/laxyos/basilisk/src/grid/tree.h"
#line 24 "/home/laxyos/basilisk/src/grid/tree.h"
typedef struct {
...
static void cache_level_shrink (CacheLevel * c)
{
  if (c->nm > (c->n/128 + 1)*128) {
    c->nm = (c->n/128 + 1)*128;
    if (!(c->nm > c->n)) qassert ("/home/laxyos/basilisk/src/grid/tree.h", 200, "c->nm > c->n");
...
#line 243 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 284 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 1 "/home/laxyos/basilisk/src/grid/foreach_cell.h"
#line 66 "/home/laxyos/basilisk/src/grid/foreach_cell.h"
...
#line 339 "/home/laxyos/basilisk/src/grid/tree.h"
#line 356 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 402 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 1 "/home/laxyos/basilisk/src/grid/neighbors.h"
#line 17 "/home/laxyos/basilisk/src/grid/neighbors.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 529 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 552 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 560 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 571 "/home/laxyos/basilisk/src/grid/tree.h"
 {
...
#line 595 "/home/laxyos/basilisk/src/grid/tree.h"
    if (!(cell.pid < 0)) {
...
#line 673 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 724 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 754 "/home/laxyos/basilisk/src/grid/tree.h"
 {
      point.level = l;
...
#line 814 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 929 "/home/laxyos/basilisk/src/grid/tree.h"
static void alloc_children (Point point)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 930 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 962 "/home/laxyos/basilisk/src/grid/tree.h"
  }
...
#line 991 "/home/laxyos/basilisk/src/grid/tree.h"
static void free_children (Point point)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 992 "/home/laxyos/basilisk/src/grid/tree.h"


  Layer * L = ((Tree *)grid)->L[point.level + 1];
  int i = 2*point.i - 2, j = 2*point.j - 2;
  if (!(((L->m)->b[i][j]))) qassert ("/home/laxyos/basilisk/src/grid/tree.h", 996, "mem_data (L->m,i,j)");
  ...
  if (--L->nc == 0) {
    destroy_layer (L);
    if (!(point.level + 1 == grid->depth)) qassert ("/home/laxyos/basilisk/src/grid/tree.h", 1003, "point.level + 1 == grid->depth");
    update_depth (-1);
  }
...
#line 992 "/home/laxyos/basilisk/src/grid/tree.h"
  ...
  Layer * L = ((Tree *)grid)->L[point.level + 1];
  int i = 2*point.i - 2, j = 2*point.j - 2;
  IF (!(((L->m)->b[i][j]))) _stencil_qassert (__FILE__,__LINE__,"/home/laxyos/basilisk/src/grid/tree.h", 996, "mem_data (L->m,i,j)");
  mempool_free (L->pool, ((L->m)->b[i][j]));
  for (int k = 0; k < 2; k++)
    for (int l = 0; l < 2; l++)
      free_periodic (L->m, i + k, j + l, L->len);
  IF (--L->nc == 0) {
    destroy_layer (L);
    IF (!(point.level + 1 == grid->depth)) _stencil_qassert (__FILE__,__LINE__,"/home/laxyos/basilisk/src/grid/tree.h", 1003, "point.level + 1 == grid->depth");
    update_depth (-1);
  }
...
#line 1032 "/home/laxyos/basilisk/src/grid/tree.h"
void increment_neighbors (Point point)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1033 "/home/laxyos/basilisk/src/grid/tree.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1044 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 1070 "/home/laxyos/basilisk/src/grid/tree.h"
 {
...
#line 1089 "/home/laxyos/basilisk/src/grid/tree.h"
 {
...
#line 1115 "/home/laxyos/basilisk/src/grid/tree.h"
    } } end_foreach_mem(); }
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1140 "/home/laxyos/basilisk/src/grid/tree.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1170 "/home/laxyos/basilisk/src/grid/tree.h"
...
static bool diagonal_neighbor_3D (Point point,
      scalar * scalars, vector * vectors)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1213 "/home/laxyos/basilisk/src/grid/tree.h"

#line 1257 "/home/laxyos/basilisk/src/grid/tree.h"
  return false;
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1263 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 1282 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 1303 "/home/laxyos/basilisk/src/grid/tree.h"
 {
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1373 "/home/laxyos/basilisk/src/grid/tree.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1383 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 1405 "/home/laxyos/basilisk/src/grid/tree.h"
 {
...
#line 1445 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 1465 "/home/laxyos/basilisk/src/grid/tree.h"
 {
...
{ trace ("init_grid", "/home/laxyos/basilisk/src/grid/tree.h", 1490);

  if (!(sizeof(Cell) % 8 == 0)) qassert ("/home/laxyos/basilisk/src/grid/tree.h", 1492, "sizeof(Cell) % 8 == 0");
  ...
  Layer * L = new_layer (0);
  q->L[0] = L;
#line 1528 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 1566 "/home/laxyos/basilisk/src/grid/tree.h"
  ...
  reset (all, 0.);
  { if (((Tree *)grid)->dirty) update_cache_f(); };
 end_trace("init_grid", "/home/laxyos/basilisk/src/grid/tree.h", 1584); }
...
#line 1589 "/home/laxyos/basilisk/src/grid/tree.h"
 ...
 for (int l = -1; l <= 1; l++) {
   ...
   if (x > -0.5 && x < 0.5 && y > -0.5 && y < 0.5 &&
     ...
     if (!(false)) qassert ("/home/laxyos/basilisk/src/grid/tree.h", 1614, "false");
   }
 } } end_foreach_leaf(); }
}
...
#line 1625 "/home/laxyos/basilisk/src/grid/tree.h"
 ...
 return point;
  ...
  Point point = {0};  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 1649 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 1 "/home/laxyos/basilisk/src/grid/tree-common.h"



#line 1 "grid/multigrid-common.h"
#line 1 "/home/laxyos/basilisk/src/grid/multigrid-common.h"


#line 1 "grid/cartesian-common.h"
#line 1 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
#line 1 "grid/events.h"
#line 1 "/home/laxyos/basilisk/src/grid/events.h"
...
void event_register (Event event) {
  if (!(Events)) qassert ("/home/laxyos/basilisk/src/grid/events.h", 87, "Events");
  if (!(!event.last)) qassert ("/home/laxyos/basilisk/src/grid/events.h", 88, "!event.last");
  int n = 0, parent = -1;
  for (Event * ev = Events; !ev->last; ev++) {
    if (!strcmp (event.name, ev->name)) {
      if (!(parent < 0)) qassert ("/home/laxyos/basilisk/src/grid/events.h", 92, "parent < 0");
      parent = n;
    }
    n++;
  }
...
#line 131 "/home/laxyos/basilisk/src/grid/events.h"
...
double dtnext (double dt)
{
  if (tnext != HUGE && tnext > t) {
    ...
    if (!(n < INT_MAX)) qassert ("/home/laxyos/basilisk/src/grid/events.h", 245, "n < INT_MAX");
    if (n == 0)
      dt = tnext - t;
    else {
...
#line 2 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
...
#line 1 "grid/fpe.h"
#line 1 "/home/laxyos/basilisk/src/grid/fpe.h"
...
#line 37 "/home/laxyos/basilisk/src/grid/cartesian-common.h"

#define end_foreach_face()

#line 1 "grid/stencils.h"
#line 1 "/home/laxyos/basilisk/src/grid/stencils.h"
#line 18 "/home/laxyos/basilisk/src/grid/stencils.h"
...
#line 43 "/home/laxyos/basilisk/src/grid/stencils.h"
typedef struct {
  const char * fname;
  int line;
  int first;
...
#line 59 "/home/laxyos/basilisk/src/grid/stencils.h"
...
#line 127 "/home/laxyos/basilisk/src/grid/stencils.h"
...
#line 398
 ...
 strongif (baseblock) for (scalar d = *baseblock, *_i30 = baseblock; ((scalar *)&d)->i >= 0; d = *++_i30)
  ...
  if (flux) {
#line 436 "/home/laxyos/basilisk/src/grid/stencils.h"
    boundary_face (listf);
    {
#line 437
...
#line 41 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
...
scalar new_block_scalar (const char * name, const char * ext, int block)
{
 ...
 init_block_scalar (sb, name, ext, n, block);
  ...
  s = (scalar){nvar};
  if (!(nvar + block <= _NVARMAX)) qassert ("/home/laxyos/basilisk/src/grid/cartesian-common.h", 83, "nvar + block <= _NVARMAX");
...
#line 191
 {
    ...
    t.y.x = t.x.y;
#line 211 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
  init_tensor (t, NULL);
  return t;
}
...
void scalar_clone (scalar a, scalar b)
{
  ...
  if (!(_attribute[b.i].block > 0 && _attribute[a.i].block == _attribute[b.i].block)) qassert ("/home/laxyos/basilisk/src/grid/cartesian-common.h", 256, "b.block > 0 && a.block == b.block");
...
void free_solver ()
{
  if (!(_val_higher_dimension == 0.)) qassert ("/home/laxyos/basilisk/src/grid/cartesian-common.h", 343, "_val_higher_dimension == 0.");
...
void boundary_internal (scalar * list, const char * fname, int line)
{ trace ("boundary_internal", "/home/laxyos/basilisk/src/grid/cartesian-common.h", 416);
  if (list == NULL)
    { ; end_trace("boundary_internal", "/home/laxyos/basilisk/src/grid/cartesian-common.h", 418);  return; }
  scalar * listc = NULL;
  vectorl listf = {NULL};
  bool flux = false;
...
#line 441
 ...
 end_trace("boundary_internal", "/home/laxyos/basilisk/src/grid/cartesian-common.h", 450); }
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 465 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 470 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/grid/cartesian-common.h", .line = 619,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 619 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
 {
    bool inside = true;
    coord o = {x,y,z};
    {
 ...
 inside = false;}
    IF (inside) {
      ...
      _stencil_fprintf (__FILE__,__LINE__,p.fp, "%g %g\n%g %g\n%g %g\n%g %g\n%g %g\n\n",
        ...
        x + Delta, y - Delta,
        x - Delta, y - Delta);
#line 651 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
    }
...
#line 663 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 697 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
  ...
  fputc ('\n', fp);
#line 730 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
    for (int k = -2; k <= 2; k++)
      for (int l = -2; l <= 2; l++) {
...
#line 760 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
  fclose (fp);
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 801 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
...
#line 829 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
...
{ trace ("interpolate", "/home/laxyos/basilisk/src/grid/cartesian-common.h", 833);
  scalar v = p.v;
  boundary_internal ((scalar *)(((scalar []){v,{-1}})), "/home/laxyos/basilisk/src/grid/cartesian-common.h", 835);
  Point point = locate ((struct _locate){p.x, p.y, p.z});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 836 "/home/laxyos/basilisk/src/grid/cartesian-common.h"

  if (point.level < 0)
    { double _ret =  nodata; end_trace("interpolate", "/home/laxyos/basilisk/src/grid/cartesian-common.h", 838);  return _ret; }
  { double _ret =  interpolate_linear (point, p); end_trace("interpolate", "/home/laxyos/basilisk/src/grid/cartesian-common.h", 839);  return _ret; }
 end_trace("interpolate", "/home/laxyos/basilisk/src/grid/cartesian-common.h", 840); }


void interpolate_array (scalar * list, coord * a, int n, double * v, bool linear)
{ trace ("interpolate_array", "/home/laxyos/basilisk/src/grid/cartesian-common.h", 844);
  boundary_internal ((scalar *)(list), "/home/laxyos/basilisk/src/grid/cartesian-common.h", 845);
  int j = 0;
  for (int i = 0; i < n; i++) {
    Point point = locate ((struct _locate){a[i].x, a[i].y, a[i].z});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 848 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
 ...
 v[j++] = nodata;
  ...
  MPI_MIN, 0, MPI_COMM_WORLD);
#endif
 end_trace("interpolate_array", "/home/laxyos/basilisk/src/grid/cartesian-common.h", 867); }
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 899 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
...
void periodic (int dir)
{
    ...
    if (!(dir <= bottom)) qassert ("/home/laxyos/basilisk/src/grid/cartesian-common.h", 924, "dir <= bottom");
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 937 "/home/laxyos/basilisk/src/grid/cartesian-common.h"
...
#line 4 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 27 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 35 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 43 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 61 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 66 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
#line 78 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
#line 81 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
#line 90 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
 {
       { foreach_child()
...
#line 104 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
#line 111 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
#line 115 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
 {
      _attribute[s.i].prolongation (point, s);
       { foreach_child()
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 125 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
#line 140 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 143 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 154 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 175 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 188 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 194 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
#line 206
  ...
  if (!(fabs(sum) < 1e-10)) qassert ("/home/laxyos/basilisk/src/grid/multigrid-common.h", 210, "fabs(sum) < 1e-10");
 }
strongif (is_constant(cm)) {
const double _const_cm = _constant[cm.i -_NVARMAX];
NOT_UNUSED(_const_cm);
...
#line 206
  ...
  IF (!(fabs(sum) < 1e-10)) _stencil_qassert (__FILE__,__LINE__,"/home/laxyos/basilisk/src/grid/multigrid-common.h", 210, "fabs(sum) < 1e-10");
 }
strongif (is_constant(cm)) {
const double _const_cm = _constant[cm.i -_NVARMAX];
NOT_UNUSED(_const_cm);
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 214 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 220 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 251 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
  ...
  if (point.level > 0) {
    ...
    FILE * fp = fopen (name, "w");
#line 271 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
#line 302 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
    fclose (fp);
  }
  ...
  if (is_coarse()) {
    ...
    FILE * fp = fopen (name, "w");
#line 324 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
#line 362 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
    fclose (fp);
  }
  fflush (ferr);
  fclose (plot);
...
#line 389 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
 {
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/grid/multigrid-common.h", .line = 428,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 428 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
...
#line 437 "/home/laxyos/basilisk/src/grid/multigrid-common.h"
 {
      double sum = !leaves;
       { foreach_child()
...
#line 5 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
#line 21 "/home/laxyos/basilisk/src/grid/tree-common.h"
int refine_cell (Point point, scalar * list, int flag, Cache * refined)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 22 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 99 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 137 "/home/laxyos/basilisk/src/grid/tree-common.h"
 ...
 if ((!is_leaf (cell) && cell.neighbors && cell.pid >= 0))
  ...
  if (!(coarsen_cell (point, list))) qassert ("/home/laxyos/basilisk/src/grid/tree-common.h", 146, "coarsen_cell (point, list)");
...
#line 137 "/home/laxyos/basilisk/src/grid/tree-common.h"
 ...
 IF ((!is_leaf (cell) && cell.neighbors && cell.pid >= 0))
  ...
  IF (!(coarsen_cell (point, list))) _stencil_qassert (__FILE__,__LINE__,"/home/laxyos/basilisk/src/grid/tree-common.h", 146, "coarsen_cell (point, list)");
...
{ trace ("adapt_wavelet", "/home/laxyos/basilisk/src/grid/tree-common.h", 167);
  scalar * list = p.list;

  if (is_constant(cm)) {
    if (list == NULL || list == all)
      list = list_copy (all);
    boundary_internal ((scalar *)(list), "/home/laxyos/basilisk/src/grid/tree-common.h", 173);
    restriction (p.slist);
  }
  else {
    if (list == NULL || list == all) {
 ...
 list = list_add (list, s);
    ...
    boundary_internal ((scalar *)(list), "/home/laxyos/basilisk/src/grid/tree-common.h", 182);
...
#line 199 "/home/laxyos/basilisk/src/grid/tree-common.h"
 {
    if (is_active(cell)) {
...
#line 271 "/home/laxyos/basilisk/src/grid/tree-common.h"
 ...
 if (level == l) {
  ...
  { astats _ret =  st; end_trace("adapt_wavelet", "/home/laxyos/basilisk/src/grid/tree-common.h", 305);  return _ret; }
 end_trace("adapt_wavelet", "/home/laxyos/basilisk/src/grid/tree-common.h", 306); }
#line 328 "/home/laxyos/basilisk/src/grid/tree-common.h"
static void refine_level (int depth)
{
  int refined;
  do {
...
#line 334 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
#line 373 "/home/laxyos/basilisk/src/grid/tree-common.h"

static void halo_face (vectorl vl)
{ trace ("halo_face", "/home/laxyos/basilisk/src/grid/tree-common.h", 375);
  {
#line 376
...
#line 381 "/home/laxyos/basilisk/src/grid/tree-common.h"

      {
#line 382

        if (vl.x) {
#line 392 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
#line 408 "/home/laxyos/basilisk/src/grid/tree-common.h"
 }
#line 382
...
#line 408 "/home/laxyos/basilisk/src/grid/tree-common.h"
 ...
 end_trace("halo_face", "/home/laxyos/basilisk/src/grid/tree-common.h", 409); }
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 421 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
#line 453 "/home/laxyos/basilisk/src/grid/tree-common.h"
      }
#line 440
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 466 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
#line 511 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 514 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 521 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
#line 571 "/home/laxyos/basilisk/src/grid/tree-common.h"
  }
...
{ trace ("tree_boundary_level", "/home/laxyos/basilisk/src/grid/tree-common.h", 589);
  int depth = l < 0 ? depth() : l;

  if (tree_is_full()) {
    { Boundary ** _i = boundaries, * _b; while (_i && (_b = *_i++)) if (_b->level) _b->level (_b, list, depth); };
    { ; end_trace("tree_boundary_level", "/home/laxyos/basilisk/src/grid/tree-common.h", 594);  return; }
  }
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/grid/tree-common.h", .line = 624,
    .each = "foreach_vertex", .first = _first_call
  };
foreach_vertex_stencil(){

#line 624 "/home/laxyos/basilisk/src/grid/tree-common.h"
 {
...
#line 673 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
#line 678 "/home/laxyos/basilisk/src/grid/tree-common.h"
 {
...
#line 704 "/home/laxyos/basilisk/src/grid/tree-common.h"
 {
...
#line 708
 ...
 end_trace("tree_boundary_level", "/home/laxyos/basilisk/src/grid/tree-common.h", 716); }

double treex (Point point) { int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 718 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
#line 731 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
#line 739 "/home/laxyos/basilisk/src/grid/tree-common.h"
...
void tree_check ()
{ trace ("tree_check", "/home/laxyos/basilisk/src/grid/tree-common.h", 749);


  long nleaves = 0, nactive = 0;
   { foreach_cell_all(){

#line 753 "/home/laxyos/basilisk/src/grid/tree-common.h"
 {
    if (is_leaf(cell)) {
      if (!(cell.pid >= 0)) qassert ("/home/laxyos/basilisk/src/grid/tree-common.h", 755, "cell.pid >= 0");
      nleaves++;
    }
    if (is_local(cell))
      if (!(is_active(cell) || (!is_leaf(cell) && !cell.neighbors && cell.pid >= 0))) qassert ("/home/laxyos/basilisk/src/grid/tree-common.h", 759, "is_active(cell) || is_prolongation(cell)");
    if (is_active(cell))
      nactive++;
 ...
 neighbors++; end_foreach_neighbor(); }
    if (!(cell.neighbors == neighbors)) qassert ("/home/laxyos/basilisk/src/grid/tree-common.h", 767, "cell.neighbors == neighbors");


    if (!cell.neighbors)
      if (!(!allocated_child(0,0,0))) qassert ("/home/laxyos/basilisk/src/grid/tree-common.h", 771, "!allocated_child(0)");
...
#line 776 "/home/laxyos/basilisk/src/grid/tree-common.h"
 {
    if (is_active(cell))
      reachable++;
    else
  ...
  if (!(nactive == reachable)) qassert ("/home/laxyos/basilisk/src/grid/tree-common.h", 782, "nactive == reachable");


  reachable = 0;
   { foreach_cell(){

#line 786 "/home/laxyos/basilisk/src/grid/tree-common.h"

    if (is_leaf(cell)) {
      reachable++;
      continue;
    } } end_foreach_cell(); }
  if (!(nleaves == reachable)) qassert ("/home/laxyos/basilisk/src/grid/tree-common.h", 791, "nleaves == reachable");
 end_trace("tree_check", "/home/laxyos/basilisk/src/grid/tree-common.h", 792); }


static void tree_restriction (scalar * list) { trace ("tree_restriction", "/home/laxyos/basilisk/src/grid/tree-common.h", 795);
  boundary_internal ((scalar *)(list), "/home/laxyos/basilisk/src/grid/tree-common.h", 796);
  if (tree_is_full())
    multigrid_restriction (list);
 end_trace("tree_restriction", "/home/laxyos/basilisk/src/grid/tree-common.h", 799); }
...
#line 1663 "/home/laxyos/basilisk/src/grid/tree.h"
...
#line 1 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 39 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
#line 55 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
{
  if (!(pid >= 0 && pid < npe())) qassert ("/home/laxyos/basilisk/src/grid/tree-mpi.h", 88, "pid >= 0 && pid < npe()");
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 108 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
#line 165 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
...
#line 234 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
static void mpi_recv_check (void * buf, int count, MPI_Datatype datatype,
       int source, int tag,
       MPI_Comm comm, MPI_Status * status,
       const char * name)
{
#line 269 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
static int mpi_waitany (int count, MPI_Request array_of_requests[], int *indx,
   MPI_Status *status)
{ trace ("mpi_waitany", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 293);
  { int _ret =  MPI_Waitany (count, array_of_requests, indx, status); end_trace("mpi_waitany", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 294);  return _ret; }
 end_trace("mpi_waitany", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 295); }
        ...
        vector * listf, int l)
{
  ...
  for (int i = 0; i < m->npid; i++) {
    ...
    if (l <= rcv->depth && rcv->halo[l].n > 0) {
      if (!(!rcv->buf)) qassert ("/home/laxyos/basilisk/src/grid/tree-mpi.h", 328, "!rcv->buf");
  ...
  if (nr > 0) {
    ...
    while (i != MPI_UNDEFINED) {
      Rcv * rcv = rrcv[i];
      if (!(l <= rcv->depth && rcv->halo[l].n > 0)) qassert ("/home/laxyos/basilisk/src/grid/tree-mpi.h", 355, "l <= rcv->depth && rcv->halo[l].n > 0");
      if (!(rcv->buf)) qassert ("/home/laxyos/basilisk/src/grid/tree-mpi.h", 356, "rcv->buf");
...
{ trace ("rcv_pid_wait", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 367);

  for (int i = 0; i < m->npid; i++)
    rcv_free_buf (&m->rcv[i]);
 end_trace("rcv_pid_wait", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 371); }
     ...
     vector * listf, int l)
{
  ...
  for (int i = 0; i < m->npid; i++) {
    Rcv * rcv = &m->rcv[i];
    if (l <= rcv->depth && rcv->halo[l].n > 0) {
      if (!(!rcv->buf)) qassert ("/home/laxyos/basilisk/src/grid/tree-mpi.h", 388, "!rcv->buf");
      rcv->buf = pmalloc (sizeof (double)*rcv->halo[l].n*len,__func__,__FILE__,__LINE__);
      double * b = rcv->buf;
       { foreach_cache_level(rcv->halo[l], l){

#line 391 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
...
#line 397
 ...
 strongif (listv) for (scalar s = *listv, *_i79 = listv; ((scalar *)&s)->i >= 0; s = *++_i79) {
   for (int i = 0; i <= 1; i++)
     for (int j = 0; j <= 1; j++)
#line 418 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
       {
  if (allocated(i,j,0))
...
{ trace ("mpi_boundary_level", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 493);
  MpiBoundary * m = (MpiBoundary *) b;
  rcv_pid_sync (&m->mpi_level, list, l);
  rcv_pid_sync (&m->mpi_level_root, list, l);
 end_trace("mpi_boundary_level", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 497); }


static void mpi_boundary_restriction (const Boundary * b, scalar * list, int l)
{ trace ("mpi_boundary_restriction", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 501);
  MpiBoundary * m = (MpiBoundary *) b;
  rcv_pid_sync (&m->restriction, list, l);
 end_trace("mpi_boundary_restriction", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 504); }
...
#line 568 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
{ char * prefix = _prefix; NOT_UNUSED(prefix);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/grid/tree-mpi.h", .line = 581,
...
#line 581 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
#line 582
 ...
 for (int i = 0; i < (80); i++)
   if (_prefix[i] != prefix[i]) {
     reduction_warning ("/home/laxyos/basilisk/src/grid/tree-mpi.h", 581, "prefix");
     break; }
 }
  _first_call = false;
}}
...
{ char * prefix = _prefix; NOT_UNUSED(prefix);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/grid/tree-mpi.h", .line = 587,
    .each = "foreach_vertex", .first = _first_call
  };
foreach_vertex_stencil(){

#line 587 "/home/laxyos/basilisk/src/grid/tree-mpi.h"

    _stencil_fprintf (__FILE__,__LINE__,fp, "%s%g %g %g %d\n", prefix, x, y, z, level); } end_foreach_vertex_stencil(); if (_first_call) {
 for (int i = 0; i < (80); i++)
   if (_prefix[i] != prefix[i]) {
     reduction_warning ("/home/laxyos/basilisk/src/grid/tree-mpi.h", 587, "prefix");
     break; }
 }
  _first_call = false;
}}
...
{ char * prefix = _prefix; NOT_UNUSED(prefix);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/grid/tree-mpi.h", .line = 593,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 593 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
    int n = 0;
     { foreach_neighbor(1)
      IF ((!is_leaf (cell) && cell.neighbors && cell.pid >= 0))
 n++; end_foreach_neighbor(); }
    ...
    IF (!(cell.neighbors == n)) _stencil_qassert (__FILE__,__LINE__,"/home/laxyos/basilisk/src/grid/tree-mpi.h", 599, "cell.neighbors == n");
  } } end_foreach_stencil(); if (_first_call) {
 for (int i = 0; i < (80); i++)
   if (_prefix[i] != prefix[i]) {
     reduction_warning ("/home/laxyos/basilisk/src/grid/tree-mpi.h", 593, "prefix");
     break; }
 }
  _first_call = false;
}}
...
#line 593 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 ...
 n++; end_foreach_neighbor(); }
    fprintf (fp, "%s%g %g %g %d\n", prefix, x, y, z, cell.neighbors);
    if (!(cell.neighbors == n)) qassert ("/home/laxyos/basilisk/src/grid/tree-mpi.h", 599, "cell.neighbors == n");
  } } end_foreach(); }
  if (!fp1)
    fclose (fp);
...
#line 637 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
    if (is_border(cell))
...
#line 650 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
    if (!is_local(cell))
...
#line 679 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 697 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 707 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 733 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 761 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 850 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
{ trace ("mpi_boundary_update_buffers", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 859);
  if (npe() == 1)
    { ; end_trace("mpi_boundary_update_buffers", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 861);  return; }
...
#line 875 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
...
#line 980 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 ...
 continue;
  ...
  prof_stop();
#line 1012 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 end_trace("mpi_boundary_update_buffers", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1012); }


void mpi_boundary_refine (scalar * list)
{ trace ("mpi_boundary_refine", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1016);
...
#line 1050 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 ...
 if (level <= depth() && allocated(0,0,0)) {
  ...
  strongif (list) for (scalar s = *list, *_i81 = list; ((scalar *)&s)->i >= 0; s = *++_i81)
    _attribute[s.i].dirty = true;
 end_trace("mpi_boundary_refine", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1082); }

static void check_depth ()
{
#line 1117 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
}
...
{ trace ("mpi_boundary_coarsen", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1127);
  if (npe() == 1)
    { ; end_trace("mpi_boundary_coarsen", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1129);  return; }

  check_depth();

  if (!(sizeof(Remote) == sizeof(double))) qassert ("/home/laxyos/basilisk/src/grid/tree-mpi.h", 1133, "sizeof(Remote) == sizeof(double)");

  scalar remote= new_scalar("remote");
   { foreach_cell(){

#line 1136 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
    if (level == l) {
      if (is_local(cell)) {
...
#line 1153 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
    if (level == l) {
      if (!is_local(cell)) {
...
#line 1173 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
      if (level == l) {
...
#line 1182 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
      if (level == l)
 ...
 delete (((scalar []){remote,{-1}}));  end_trace("mpi_boundary_coarsen", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1192); }

static void flag_border_cells ()
{
   { foreach_cell(){

#line 1196 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
    if (is_active(cell)) {
...
{ trace ("mpi_partitioning", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1247);
...
{ long nt = _nt; NOT_UNUSED(nt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/grid/tree-mpi.h", .line = 1251,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 1251 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
#line 1257 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 ...
 end_trace("mpi_partitioning", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1285); }
...
#line 1296 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
#line 1332 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
    unsigned flags;
    if (fread (&flags, sizeof(unsigned), 1, fp) != 1) {
      fprintf (ferr, "restore(): error: expecting 'flags'\n");
...
#line 1376 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
    cell.flags &= ~set;
    if (is_active (cell)) {
      if (is_leaf (cell)) {
...
#line 1425 "/home/laxyos/basilisk/src/grid/tree-mpi.h"

double z_indexing (scalar index, bool leaves)
{ trace ("z_indexing", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1427);
...
#line 1441 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
#line 1447 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
...
#line 1451 "/home/laxyos/basilisk/src/grid/tree-mpi.h"
 {
      if (level == l) {
 if (is_leaf(cell)) {
 ...
 continue;
  ...
  { double _ret =  maxi; delete (((scalar []){size,{-1}}));  end_trace("z_indexing", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1482);  return _ret; }
 delete (((scalar []){size,{-1}}));  end_trace("z_indexing", "/home/laxyos/basilisk/src/grid/tree-mpi.h", 1483); }
#line 1678 "/home/laxyos/basilisk/src/grid/tree.h"
#line 1 "grid/balance.h"
#line 1 "/home/laxyos/basilisk/src/grid/balance.h"
...
#line 21 "/home/laxyos/basilisk/src/grid/balance.h"
...
#line 26 "/home/laxyos/basilisk/src/grid/balance.h"
 {
    if (cell.flags & sent) {
 ...
 if (!(is_leaf(cell))) qassert ("/home/laxyos/basilisk/src/grid/balance.h", 34, "is_leaf(cell)");
      if (is_refined_check()) {
...
#define end_foreach_tree()\
      ...
      _i += sizeof(Cell);\
    if (c->flags & _next) {\
      if (!(c->neighbors)) qassert ("/home/laxyos/basilisk/src/grid/balance.h", 81, "c->neighbors");\
...
#line 99 "/home/laxyos/basilisk/src/grid/balance.h"
 {
...
#line 156 "/home/laxyos/basilisk/src/grid/balance.h"
 {
      memcpy (((char *)&cell) + sizeof(Cell), ((char *)c) + sizeof(Cell),
       datasize);
      if (!(((NewPid *)&val(newpid,0,0,0))->pid > 0)) qassert ("/home/laxyos/basilisk/src/grid/balance.h", 159, "NEWPID()->pid > 0");
      if (fp)
...
bool balance ()
{ trace ("balance", "/home/laxyos/basilisk/src/grid/balance.h", 201);
  if (npe() == 1)
    { bool _ret =  false; end_trace("balance", "/home/laxyos/basilisk/src/grid/balance.h", 203);  return _ret; }

  if (!(sizeof(NewPid) == sizeof(double))) qassert ("/home/laxyos/basilisk/src/grid/balance.h", 205, "sizeof(NewPid) == sizeof(double)");
...
#line 210 "/home/laxyos/basilisk/src/grid/balance.h"
 {
    if (is_local(cell)) {
      nt++;
      if (is_leaf(cell))
 nl++;
  ...
  if (nmax - nmin <= 1)
    { bool _ret =  false; end_trace("balance", "/home/laxyos/basilisk/src/grid/balance.h", 243);  return _ret; }

  scalar newpid= new_scalar("newpid");
  double zn = z_indexing (newpid, mpi.leaves);
  if (pid() == 0)
    if (!(zn + 1 == nt)) qassert ("/home/laxyos/basilisk/src/grid/balance.h", 248, "zn + 1 == nt");

  FILE * fp = NULL;
#line 260 "/home/laxyos/basilisk/src/grid/balance.h"
  bool next = false, prev = false;
   { foreach_cell_all(){

#line 261 "/home/laxyos/basilisk/src/grid/balance.h"
 {
    if (is_local(cell)) {
...
#line 304 "/home/laxyos/basilisk/src/grid/balance.h"
...
#line 338 "/home/laxyos/basilisk/src/grid/balance.h"
 {
    if (cell.pid >= 0) {
      if (is_newpid()) {
 if (fp)
...
#line 370 "/home/laxyos/basilisk/src/grid/balance.h"
 ...
 cell.flags = flags;
  ...
  { bool _ret =  pid_changed; delete (((scalar []){newpid,{-1}}));  end_trace("balance", "/home/laxyos/basilisk/src/grid/balance.h", 390);  return _ret; }
 delete (((scalar []){newpid,{-1}}));  end_trace("balance", "/home/laxyos/basilisk/src/grid/balance.h", 391); }
...
void mpi_boundary_update (scalar * list)
{
  ...
  strongif (list) for (scalar s = *list, *_i84 = list; ((scalar *)&s)->i >= 0; s = *++_i84)
    _attribute[s.i].dirty = true;
  grid->tn = 0;
  boundary_internal ((scalar *)(list), "/home/laxyos/basilisk/src/grid/balance.h", 399);
  while (balance());
}
#line 1679 "/home/laxyos/basilisk/src/grid/tree.h"
#else
void mpi_boundary_refine (scalar * list){}
...
void mpi_boundary_update (scalar * list) {
  strongif (list) for (scalar s = *list, *_i85 = list; ((scalar *)&s)->i >= 0; s = *++_i85)
    _attribute[s.i].dirty = true;
  boundary_internal ((scalar *)(list), "/home/laxyos/basilisk/src/grid/tree.h", 1685);
}
#endif
#line 4 "/home/laxyos/basilisk/src/grid/quadtree.h"

void quadtree_methods () {
  tree_methods();
}
#line 15 "shear_square-cpp.c"
...
#line 1 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
#line 27 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
#line 1 "./run.h"
#line 1 "/home/laxyos/basilisk/src/run.h"
#line 9 "/home/laxyos/basilisk/src/run.h"
double dt = 1.;

#line 1 "./utils.h"
#line 1 "/home/laxyos/basilisk/src/utils.h"
...
{ double n = _n; NOT_UNUSED(n);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/utils.h", .line = 69,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 69 "/home/laxyos/basilisk/src/utils.h"
...
{ double max = _max; NOT_UNUSED(max);
 ...
 double volume = _volume; NOT_UNUSED(volume);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/utils.h", .line = 135,
    .each = "foreach", .first = _first_call
  };
...
#line 136 "/home/laxyos/basilisk/src/utils.h"
...
{ double sum = _sum; NOT_UNUSED(sum);
 ...
 double min = _min; NOT_UNUSED(min);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/utils.h", .line = 163,
    .each = "foreach", .first = _first_call
  };
...
#line 164 "/home/laxyos/basilisk/src/utils.h"
...
#line 187 "/home/laxyos/basilisk/src/utils.h"
...
#line 213 "/home/laxyos/basilisk/src/utils.h"
double theta = 1.3;
...
#line 237 "/home/laxyos/basilisk/src/utils.h"
void gradients (scalar * f, vector * g)
{
  if (!(list_len(f) == vectors_len(g))) qassert ("/home/laxyos/basilisk/src/utils.h", 239, "list_len(f) == vectors_len(g)");
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/utils.h", .line = 240,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 240 "/home/laxyos/basilisk/src/utils.h"
 {
    scalar s; vector v;
...
#line 269 "/home/laxyos/basilisk/src/utils.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/utils.h", .line = 271,
    .each = "foreach", .first = _first_call
  };
...
#line 271 "/home/laxyos/basilisk/src/utils.h"
...
{ double max = _max; NOT_UNUSED(max);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/utils.h", .line = 285,
    .each = "foreach", .first = _first_call
  };
...
#line 285 "/home/laxyos/basilisk/src/utils.h"
 {
...
#define foreach_segment(_S,_p) {\
  ...
  if (!(norm > 0.)) qassert ("/home/laxyos/basilisk/src/utils.h", 331, "norm > 0.");\
...
#line 1 "./output.h"
#line 1 "/home/laxyos/basilisk/src/output.h"
#line 37 "/home/laxyos/basilisk/src/output.h"
struct OutputField {
  scalar * list;
  FILE * fp;
  int n;
...
{ trace ("output_field", "/home/laxyos/basilisk/src/output.h", 47);
  ...
  boundary_internal ((scalar *)(p.list), "/home/laxyos/basilisk/src/output.h", 58);
...
#line 73 "/home/laxyos/basilisk/src/output.h"
 ...
 fputc ('\n', p.fp);
  ...
  matrix_free (field);
 end_trace("output_field", "/home/laxyos/basilisk/src/output.h", 113); }
#line 141 "/home/laxyos/basilisk/src/output.h"
struct OutputMatrix {
  scalar f;
  FILE * fp;
  int n;
...
{ trace ("output_matrix", "/home/laxyos/basilisk/src/output.h", 150);
  if (p.n == 0) p.n = N;
  if (!p.fp) p.fp = fout;
  if (p.linear) {
    scalar f = p.f;
    boundary_internal ((scalar *)(((scalar []){f,{-1}})), "/home/laxyos/basilisk/src/output.h", 155);
  }
  float fn = p.n;
...
#line 172 "/home/laxyos/basilisk/src/output.h"

 if (!(point.level >= 0)) qassert ("/home/laxyos/basilisk/src/output.h", 173, "point.level >= 0");
 v = val(p.f,0,0,0);
      }
  ...
  fflush (p.fp);
 end_trace("output_matrix", "/home/laxyos/basilisk/src/output.h", 180); }
#line 189 "/home/laxyos/basilisk/src/output.h"
        ...
        double val, double min, double max)
{
  ...
  if (!(i < 127 - 1)) qassert ("/home/laxyos/basilisk/src/output.h", 321, "i < NCMAP - 1");
  unsigned char * c1 = (unsigned char *) &c;
  for (int j = 0; j < 3; j++)
    c1[j] = 255*(cmap[i][j]*(1. - coef) + cmap[i + 1][j]*coef);
  return c;
}
#line 340 "/home/laxyos/basilisk/src/output.h"
...
{
  if (!(pid() == 0)) qassert ("/home/laxyos/basilisk/src/output.h", 422, "pid() == 0");
  const char * ext;
...
{
  if (!(pid() == 0)) qassert ("/home/laxyos/basilisk/src/output.h", 496, "pid() == 0");
...
#line 571 "/home/laxyos/basilisk/src/output.h"
struct OutputPPM {
  scalar f;
  FILE * fp;
  int n;
...
{ trace ("output_ppm", "/home/laxyos/basilisk/src/output.h", 586);
  ...
  if (p.linear) {
    ...
    if (mask.i)
      boundary_internal ((scalar *)(((scalar []){f,mask,{-1}})), "/home/laxyos/basilisk/src/output.h", 608);
    else
      boundary_internal ((scalar *)(((scalar []){f,{-1}})), "/home/laxyos/basilisk/src/output.h", 610);
  }
...
#line 636 "/home/laxyos/basilisk/src/output.h"
  ...
  v = val(p.f,0,0,0);
     ...
     Point point = locate ((struct _locate){xp, yp, p.z});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 646 "/home/laxyos/basilisk/src/output.h"
  ...
  matrix_free (ppm);
 end_trace("output_ppm", "/home/laxyos/basilisk/src/output.h", 678); }
#line 710 "/home/laxyos/basilisk/src/output.h"
struct OutputGRD {
  scalar f;
  FILE * fp;
  double Delta;
...
{ trace ("output_grd", "/home/laxyos/basilisk/src/output.h", 721);
  ...
  if (p.linear) {
    scalar f = p.f, mask = p.mask;
    if (mask.i)
      boundary_internal ((scalar *)(((scalar []){f,mask,{-1}})), "/home/laxyos/basilisk/src/output.h", 733);
    else
      boundary_internal ((scalar *)(((scalar []){f,{-1}})), "/home/laxyos/basilisk/src/output.h", 735);
  }
 ...
 if (p.linear) {
   ...
   Point point = locate ((struct _locate){xp, yp});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 764 "/home/laxyos/basilisk/src/output.h"
 ...
 Point point = locate ((struct _locate){xp, yp});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 774 "/home/laxyos/basilisk/src/output.h"
 ...
 fprintf (p.fp, "%f ", v);
  ...
  fflush (p.fp);
 end_trace("output_grd", "/home/laxyos/basilisk/src/output.h", 786); }
#line 813 "/home/laxyos/basilisk/src/output.h"
struct OutputGfs {
  FILE * fp;
  scalar * list;
  double t;
...
{ trace ("output_gfs", "/home/laxyos/basilisk/src/output.h", 843);
  char * fname = p.file;
...
#line 921 "/home/laxyos/basilisk/src/output.h"
 {
#if _MPI
    if (is_local(cell))
#endif
 ...
 3;
#line 951 "/home/laxyos/basilisk/src/output.h"
      if (is_leaf(cell))
 flags |= (1 << 4);
...
#endif
 end_trace("output_gfs", "/home/laxyos/basilisk/src/output.h", 1019); }
#line 1043 "/home/laxyos/basilisk/src/output.h"
struct Dump {
  char * file;
  scalar * list;
  FILE * fp;
...
{ trace ("dump", "/home/laxyos/basilisk/src/output.h", 1097);
  FILE * fp = p.fp;
  ...
  if (!(fp)) qassert ("/home/laxyos/basilisk/src/output.h", 1112, "fp");
...
#line 1123 "/home/laxyos/basilisk/src/output.h"
 {
 ...
 delete (((scalar []){size,{-1}}));  end_trace("dump", "/home/laxyos/basilisk/src/output.h", 1145); }
#else

void dump (struct Dump p)
{ trace ("dump", "/home/laxyos/basilisk/src/output.h", 1149);
  FILE * fp = p.fp;
  char def[] = "dump", * file = p.file ? p.file : p.fp ? NULL : def;
...
#line 1195 "/home/laxyos/basilisk/src/output.h"
 {
 ...
 fwrite (&val(s,0,0,0), 1, sizeof(double), fh);
  ...
  if (!p.unbuffered && pid() == 0)
    rename (name, file);
 delete (((scalar []){size,{-1}}));  end_trace("dump", "/home/laxyos/basilisk/src/output.h", 1219); }
#endif


bool restore (struct Dump p)
{ trace ("restore", "/home/laxyos/basilisk/src/output.h", 1224);
  FILE * fp = p.fp;
  char * file = p.file;
  if (file && (fp = fopen (file, "r")) == NULL)
    { bool _ret =  false; end_trace("restore", "/home/laxyos/basilisk/src/output.h", 1228);  return _ret; }
  if (!(fp)) qassert ("/home/laxyos/basilisk/src/output.h", 1229, "fp");
...
#line 1239 "/home/laxyos/basilisk/src/output.h"
 {
    cell.pid = pid();
    cell.flags |= active;
  } } end_foreach_cell(); }
  ((Tree *)grid)->dirty = true;
#line 1264 "/home/laxyos/basilisk/src/output.h"
...
#line 1339 "/home/laxyos/basilisk/src/output.h"
  scalar * listm = is_constant(cm) ? NULL : (scalar *)((vector []){{fm.x,fm.y},{{-1},{-1}}});
...
#line 1343 "/home/laxyos/basilisk/src/output.h"
 {
    unsigned flags;
    if (fread (&flags, sizeof(unsigned), 1, fp) != 1) {
      fprintf (ferr, "restore(): error: expecting 'flags'\n");
    ...
    strongif (list) for (scalar s = *list, *_i102 = list; ((scalar *)&s)->i >= 0; s = *++_i102) {
      double val;
      if (fread (&val, sizeof(double), 1, fp) != 1) {
 fprintf (ferr, "restore(): error: expecting a scalar\n");
 exit (1);
 ...
 val(s,0,0,0) = val;
  ...
  strongif (all) for (scalar s = *all, *_i103 = all; ((scalar *)&s)->i >= 0; s = *++_i103)
    _attribute[s.i].dirty = true;


  scalar * other = NULL;
  strongif (all) for (scalar s = *all, *_i104 = all; ((scalar *)&s)->i >= 0; s = *++_i104)
  ...
  { bool _ret =  true; end_trace("restore", "/home/laxyos/basilisk/src/output.h", 1389);  return _ret; }
 end_trace("restore", "/home/laxyos/basilisk/src/output.h", 1390); }
#line 376 "/home/laxyos/basilisk/src/utils.h"
#line 12 "/home/laxyos/basilisk/src/run.h"


void run (void)
{ trace ("run", "/home/laxyos/basilisk/src/run.h", 15);
  iter = 0, t = 0., dt = 1.;
  init_grid (N);
  ...
  free_grid();
 end_trace("run", "/home/laxyos/basilisk/src/run.h", 37); }




static int defaults_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults (const int i, const double t, Event * _ev) { trace ("defaults", "/home/laxyos/basilisk/src/run.h", 42);  {
  display ((struct _display){"box();"});
 end_trace("defaults", "/home/laxyos/basilisk/src/run.h", 44); } return 0; } 





static int cleanup_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 1234567890);   *ip = i; *tp = t;   return ret; } static int cleanup (const int i, const double t, Event * _ev) { trace ("cleanup", "/home/laxyos/basilisk/src/run.h", 50);  {
  display ((struct _display){"", true});
 end_trace("cleanup", "/home/laxyos/basilisk/src/run.h", 52); } return 0; } 
#line 28 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
#line 1 "./timestep.h"
#line 1 "/home/laxyos/basilisk/src/timestep.h"
...
{ double dtmax = _dtmax; NOT_UNUSED(dtmax);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/timestep.h", .line = 6,
    .each = "foreach_face", .first = _first_call
  };
...
#line 6 "/home/laxyos/basilisk/src/timestep.h"
...
#line 29 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
#line 1 "./bcg.h"
#line 1 "/home/laxyos/basilisk/src/bcg.h"
#line 11 "/home/laxyos/basilisk/src/bcg.h"
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/bcg.h", .line = 28,
    .each = "foreach_face", .first = _first_call
  };
...
#line 28 "/home/laxyos/basilisk/src/bcg.h"
 {
...
#line 58 "/home/laxyos/basilisk/src/bcg.h"
...
#line 59
 ...
 if (dt != _dt)
   reduction_warning ("/home/laxyos/basilisk/src/bcg.h", 28, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
void advection (struct Advection p)
{
  ...
  scalar * lsrc = p.src;
  if (!lsrc)
    strongif (p.tracers) for (scalar s = *p.tracers, *_i105 = p.tracers; ((scalar *)&s)->i >= 0; s = *++_i105)
      lsrc = list_append (lsrc, zeroc);
  if (!(list_len(p.tracers) == list_len(lsrc))) qassert ("/home/laxyos/basilisk/src/bcg.h", 84, "list_len(p.tracers) == list_len(lsrc)");
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/bcg.h", .line = 91,
    .each = "foreach", .first = _first_call
  };
...
#line 91 "/home/laxyos/basilisk/src/bcg.h"
...
#line 30 "/home/laxyos/basilisk/src/navier-stokes/centered.h"



#line 1 "./viscosity.h"
#line 1 "/home/laxyos/basilisk/src/viscosity.h"
#line 1 "./poisson.h"
#line 1 "/home/laxyos/basilisk/src/poisson.h"
#line 32 "/home/laxyos/basilisk/src/poisson.h"
...
#line 55 "/home/laxyos/basilisk/src/poisson.h"
...
#line 65 "/home/laxyos/basilisk/src/poisson.h"

 strongif (da) for (scalar s = *da, *_i107 = da; ((scalar *)&s)->i >= 0; s = *++_i107)
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/poisson.h", .line = 84,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 84 "/home/laxyos/basilisk/src/poisson.h"
 {
    scalar s, ds;
...
#line 102 "/home/laxyos/basilisk/src/poisson.h"
...
#line 125 "/home/laxyos/basilisk/src/poisson.h"
struct MGSolve {
  scalar * a, * b;
...
mgstats mg_solve (struct MGSolve p)
{
  ...
  for (int b = 0; b < nboundary; b++)
    strongif (da) for (scalar s = *da, *_i108 = da; ((scalar *)&s)->i >= 0; s = *++_i108)
      _attribute[s.i].boundary[b] = _attribute[s.i].boundary_homogeneous[b];
...
{ double sum = _sum; NOT_UNUSED(sum);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/poisson.h", .line = 164,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 164 "/home/laxyos/basilisk/src/poisson.h"

    strongif (p.b) for (scalar s = *p.b, *_i109 = p.b; ((scalar *)&s)->i >= 0; s = *++_i109)
...
#line 199 "/home/laxyos/basilisk/src/poisson.h"
...
#line 258 "/home/laxyos/basilisk/src/poisson.h"
struct Poisson {
  scalar a, b;
   vector alpha;
   scalar lambda;
...
#line 296 "/home/laxyos/basilisk/src/poisson.h"
  scalar c = a;
...
#line 303 "/home/laxyos/basilisk/src/poisson.h"
 {
...
#line 319 "/home/laxyos/basilisk/src/poisson.h"
      val(c,0,0,0) = n/d;
...
#line 338 "/home/laxyos/basilisk/src/poisson.h"
}
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/poisson.h", .line = 358,
    .each = "foreach_face", .first = _first_call
  };
...
#line 358 "/home/laxyos/basilisk/src/poisson.h"
...
{ double maxres = _maxres; NOT_UNUSED(maxres);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/poisson.h", .line = 360,
    .each = "foreach", .first = _first_call
  };
...
#line 360 "/home/laxyos/basilisk/src/poisson.h"
 {
...
#line 390 "/home/laxyos/basilisk/src/poisson.h"
  { double _ret =  maxres; delete (((scalar []){g.x,g.y,{-1}}));  return _ret; }
 delete (((scalar []){g.x,g.y,{-1}})); }
#line 402 "/home/laxyos/basilisk/src/poisson.h"
...
#line 460 "/home/laxyos/basilisk/src/poisson.h"
struct Project {
  vector uf;
  scalar p;
  vector alpha;
...
{ trace ("project", "/home/laxyos/basilisk/src/poisson.h", 470);
  vector uf = q.uf;
  scalar p = q.p;
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/poisson.h", .line = 483,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 483 "/home/laxyos/basilisk/src/poisson.h"
 {
...
#line 485
 ...
 if (dt != _dt)
   reduction_warning ("/home/laxyos/basilisk/src/poisson.h", 483, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 499 "/home/laxyos/basilisk/src/poisson.h"
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/poisson.h", .line = 505,
    .each = "foreach_face", .first = _first_call
  };
...
#line 505 "/home/laxyos/basilisk/src/poisson.h"
...
#line 506
 ...
 if (dt != _dt)
   reduction_warning ("/home/laxyos/basilisk/src/poisson.h", 505, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 506
 end_foreach_face(); } }
  ...
  { mgstats _ret =  mgp; delete (((scalar []){div,{-1}}));  end_trace("project", "/home/laxyos/basilisk/src/poisson.h", 508);  return _ret; }
 delete (((scalar []){div,{-1}}));  end_trace("project", "/home/laxyos/basilisk/src/poisson.h", 509); }
#line 2 "/home/laxyos/basilisk/src/viscosity.h"
...
#line 25 "/home/laxyos/basilisk/src/viscosity.h"
...
#line 39 "/home/laxyos/basilisk/src/viscosity.h"
 {
    {
#line 40
     ...
     (val(u.y,-1,0,0) + val(u.y,-1,1,0))/4.)
      - val_mu_y(mu.y,0,0,0)*(- val(u.x,0,-1,0) +
         ...
         (val(u.y,-1,-1,0) + val(u.y,-1,0,0))/4.)
#line 58 "/home/laxyos/basilisk/src/viscosity.h"
...
#line 85 "/home/laxyos/basilisk/src/viscosity.h"
}
      ...
      void * data)
{
  ...
  double maxres = 0.;
#line 104 "/home/laxyos/basilisk/src/viscosity.h"
  boundary_internal ((scalar *)(((vector []){{u.x,u.y},{{-1},{-1}}})), "/home/laxyos/basilisk/src/viscosity.h", 104);
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/viscosity.h", .line = 108,
    .each = "foreach_face", .first = _first_call
  };
...
#line 108 "/home/laxyos/basilisk/src/viscosity.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/viscosity.h", .line = 111,
    .each = "foreach_face", .first = _first_call
  };
...
#line 111 "/home/laxyos/basilisk/src/viscosity.h"
...
{ double dt = _dt; NOT_UNUSED(dt);
 double maxres = _maxres; NOT_UNUSED(maxres);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/viscosity.h", .line = 122,
    .each = "foreach", .first = _first_call
  };
...
#line 122 "/home/laxyos/basilisk/src/viscosity.h"
 {
      double d = 0.;
      {
#line 124
...
#line 124
 ...
 if (dt != _dt)
   reduction_warning ("/home/laxyos/basilisk/src/viscosity.h", 122, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 129
   ...
   delete (((scalar []){taux.x,taux.y,{-1}})); }}
#line 159 "/home/laxyos/basilisk/src/viscosity.h"
  return maxres;
}
...
{ trace ("viscosity", "/home/laxyos/basilisk/src/viscosity.h", 166);
  vector u = p.u, r= new_vector("r");
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/viscosity.h", .line = 168,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 168 "/home/laxyos/basilisk/src/viscosity.h"
...
#line 169
  ...
  { mgstats _ret =  mg_solve ((struct MGSolve){(scalar *)((vector []){{u.x,u.y},{{-1},{-1}}}), (scalar *)((vector []){{r.x,r.y},{{-1},{-1}}}),
     residual_viscosity, relax_viscosity, &p, p.nrelax, p.res}); delete (((scalar []){r.x,r.y,{-1}}));  end_trace("viscosity", "/home/laxyos/basilisk/src/viscosity.h", 177);  return _ret; }
 delete (((scalar []){r.x,r.y,{-1}}));  end_trace("viscosity", "/home/laxyos/basilisk/src/viscosity.h", 178); }


mgstats viscosity_explicit (struct Viscosity p)
{ trace ("viscosity_explicit", "/home/laxyos/basilisk/src/viscosity.h", 182);
  vector u = p.u, r= new_vector("r");
  mgstats mg = {0};
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/viscosity.h", .line = 186,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 186 "/home/laxyos/basilisk/src/viscosity.h"
...
#line 187
  ...
  { mgstats _ret =  mg; delete (((scalar []){r.x,r.y,{-1}}));  end_trace("viscosity_explicit", "/home/laxyos/basilisk/src/viscosity.h", 189);  return _ret; }
 delete (((scalar []){r.x,r.y,{-1}}));  end_trace("viscosity_explicit", "/home/laxyos/basilisk/src/viscosity.h", 190); }
#line 34 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
#line 44 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
scalar p= {0};
vector u= {{1},{2}}, g= {{3},{4}};
scalar pf= {5};
vector uf= {{6},{7}};
#line 70 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
 vector mu = {{_NVARMAX + 0},{_NVARMAX + 1}}, a = {{_NVARMAX + 0},{_NVARMAX + 1}}, alpha = {{_NVARMAX + 2},{_NVARMAX + 3}};
 scalar rho = {(_NVARMAX + 4)};
mgstats mgp, mgpf, mgu;
bool stokes = false;
#line 91 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 101 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 126 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
static int defaults_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_0 (const int i, const double t, Event * _ev) { trace ("defaults_0", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 126); 
{
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/centered.h", .line = 145,
    .each = "foreach_face", .first = _first_call
  };
...
#line 145 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 173 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
 end_trace("defaults_0", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 173); } return 0; } 





static int default_display_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int default_display (const int i, const double t, Event * _ev) { trace ("default_display", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 179); 
  display ((struct _display){"squares (color = 'u.x', spread = -1);"}); end_trace("default_display", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 180);  return 0; } 
...
static int init_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int init (const int i, const double t, Event * _ev) { trace ("init", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 188); 
{
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/centered.h", .line = 191,
    .each = "foreach_face", .first = _first_call
  };
...
#line 191 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 192
 end_foreach_face(); } }
  ...
  dtmax = DT;
  event ("stability");
 end_trace("init", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 205); } return 0; } 
#line 214 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
static int set_dtmax_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int set_dtmax (const int i, const double t, Event * _ev) { trace ("set_dtmax", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 214);  dtmax = DT; end_trace("set_dtmax", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 214);  return 0; } 

static int stability_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int stability (const int i, const double t, Event * _ev) { trace ("stability", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 216);  {
  dt = dtnext (stokes ? dtmax : timestep (uf, dtmax));
 end_trace("stability", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 218); } return 0; } 
...
static int vof_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int vof (const int i, const double t, Event * _ev) { trace ("vof", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 226); ; end_trace("vof", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 226);  return 0; } 
static int tracer_advection_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int tracer_advection (const int i, const double t, Event * _ev) { trace ("tracer_advection", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 227); ; end_trace("tracer_advection", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 227);  return 0; } 
static int tracer_diffusion_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int tracer_diffusion (const int i, const double t, Event * _ev) { trace ("tracer_diffusion", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 228); ; end_trace("tracer_diffusion", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 228);  return 0; } 
...
static int properties_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int properties (const int i, const double t, Event * _ev) { trace ("properties", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 235); ; end_trace("properties", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 235);  return 0; } 
#line 247 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
void prediction ()
{
  vector du;
  {
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/centered.h", .line = 256,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 256 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/centered.h", .line = 266,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 266 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/centered.h", .line = 277,
    .each = "foreach_face", .first = _first_call
  };
...
#line 277 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
 {
...
#line 294
 ...
 if (dt != _dt)
   reduction_warning ("/home/laxyos/basilisk/src/navier-stokes/centered.h", 277, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 308 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
static int advection_term_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int advection_term (const int i, const double t, Event * _ev) { trace ("advection_term", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 308); 
{
  if (!stokes) {
    prediction();
 ...
 end_trace("advection_term", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 315); } return 0; } 
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/centered.h", .line = 325,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 325 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 326
 ...
 if (dt != _dt)
   reduction_warning ("/home/laxyos/basilisk/src/navier-stokes/centered.h", 325, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 337 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
static int viscous_term_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int viscous_term (const int i, const double t, Event * _ev) { trace ("viscous_term", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 337); 
{
  if (constant(mu.x) != 0.) {
    correction (dt);
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/centered.h", .line = 351,
    .each = "foreach_face", .first = _first_call
  };
foreach_face_stencil() { int ig = -1; VARIABLES;  strongif (is_stencil_face_x()) {
#line 351
...
#line 351 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 352
 ...
 end_trace("viscous_term", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 354); } return 0; } 
#line 373 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
static int acceleration_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration (const int i, const double t, Event * _ev) { trace ("acceleration", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 373); 
{
  trash (((vector []){{uf.x,uf.y},{{-1},{-1}}}));
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/centered.h", .line = 376,
    .each = "foreach_face", .first = _first_call
  };
...
#line 376 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 377
 ...
 if (dt != _dt)
   reduction_warning ("/home/laxyos/basilisk/src/navier-stokes/centered.h", 376, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 377
 end_foreach_face(); } }
 end_trace("acceleration", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 378); } return 0; } 
#line 387 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/centered.h", .line = 395,
    .each = "foreach_face", .first = _first_call
  };
...
#line 395 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/centered.h", .line = 403,
    .each = "foreach", .first = _first_call
  };
...
#line 403 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
static int projection_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int projection (const int i, const double t, Event * _ev) { trace ("projection", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 413); 
{
  ...
  correction (dt);
 end_trace("projection", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 422); } return 0; } 





static int end_timestep_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int end_timestep (const int i, const double t, Event * _ev) { trace ("end_timestep", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 428); ; end_trace("end_timestep", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 428);  return 0; } 
#line 438 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
static int adapt_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int adapt (const int i, const double t, Event * _ev) { trace ("adapt", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 438);  {
  ...
  event ("properties");
 end_trace("adapt", "/home/laxyos/basilisk/src/navier-stokes/centered.h", 446); } return 0; } 
#line 9 "shear_square.c"

#line 1 "two-phaseVP.h"
#line 1 "./two-phaseVP.h"
#line 13 "./two-phaseVP.h"
#line 1 "vof.h"
#line 1 "/home/laxyos/basilisk/src/vof.h"
#line 27 "/home/laxyos/basilisk/src/vof.h"
...
#line 1 "fractions.h"
#line 1 "/home/laxyos/basilisk/src/fractions.h"
#line 12 "/home/laxyos/basilisk/src/fractions.h"
#line 1 "geometry.h"
#line 1 "/home/laxyos/basilisk/src/geometry.h"
#line 28 "/home/laxyos/basilisk/src/geometry.h"
...
#line 133 "/home/laxyos/basilisk/src/geometry.h"
...
#line 237 "/home/laxyos/basilisk/src/geometry.h"
...
#line 262 "/home/laxyos/basilisk/src/geometry.h"
...
#line 352 "/home/laxyos/basilisk/src/geometry.h"
...
#line 482 "/home/laxyos/basilisk/src/geometry.h"
...
#line 13 "/home/laxyos/basilisk/src/fractions.h"
...
#line 1 "myc2d.h"
#line 1 "/home/laxyos/basilisk/src/myc2d.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 7 "/home/laxyos/basilisk/src/myc2d.h"
...
#line 20 "/home/laxyos/basilisk/src/fractions.h"
#line 41 "/home/laxyos/basilisk/src/fractions.h"
void fraction_refine (Point point, scalar c)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 42 "/home/laxyos/basilisk/src/fractions.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 86 "/home/laxyos/basilisk/src/fractions.h"
...
#line 121 "/home/laxyos/basilisk/src/fractions.h"
struct Fractions {
  scalar Phi;
  scalar c;
  vector s;
...
{ trace ("fractions", "/home/laxyos/basilisk/src/fractions.h", 130);
  scalar Phi = a.Phi;
  scalar c = a.c;
  vector s = (a.s).x.i ? (a.s) : new_face_vector("s");
  double val = a.val;
#line 145 "/home/laxyos/basilisk/src/fractions.h"
  vector p;
  p.x = s.y; p.y = s.x;
#line 155 "/home/laxyos/basilisk/src/fractions.h"
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{  double _val = val;
{ double val = _val; NOT_UNUSED(val);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/fractions.h", .line = 155,
    .each = "foreach_face", .first = _first_call
  };
foreach_face_stencil() { int jg = -1; VARIABLES;  strongif (is_stencil_face_y()) {
#line 155
...
#line 180 "/home/laxyos/basilisk/src/fractions.h"
...
#line 182
 if (_first_call) {
 if (val != _val)
   reduction_warning ("/home/laxyos/basilisk/src/fractions.h", 155, "val");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 182
 end_foreach_face(); }
#line 205 "/home/laxyos/basilisk/src/fractions.h"
  scalar s_z = c;
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{  double _val = val;
{ double val = _val; NOT_UNUSED(val);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/fractions.h", .line = 206,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 206 "/home/laxyos/basilisk/src/fractions.h"


  {
#line 240 "/home/laxyos/basilisk/src/fractions.h"
    coord n;
    double nn = 0.;
    {
#line 242
...
#line 283 "/home/laxyos/basilisk/src/fractions.h"
      IF (ni == 0)
 ...
 if (val != _val)
   reduction_warning ("/home/laxyos/basilisk/src/fractions.h", 206, "val");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 347 "/home/laxyos/basilisk/src/fractions.h"
 { strongif (!(a.s).x.i) delete (((scalar []){s.x,s.y,{-1}})); }  end_trace("fractions", "/home/laxyos/basilisk/src/fractions.h", 347); }
#line 391 "/home/laxyos/basilisk/src/fractions.h"
coord youngs_normal (Point point, scalar c)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 392 "/home/laxyos/basilisk/src/fractions.h"

  coord n;
  double nn = 0.;
  if (!(2 == 2)) qassert ("/home/laxyos/basilisk/src/fractions.h", 395, "dimension == 2");
  {
#line 396
 {
...
#line 392 "/home/laxyos/basilisk/src/fractions.h"
  ...
  coord n;
  double nn = 0.;
  IF (!(2 == 2)) _stencil_qassert (__FILE__,__LINE__,"/home/laxyos/basilisk/src/fractions.h", 395, "dimension == 2");
  {
#line 396
 {
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 415 "/home/laxyos/basilisk/src/fractions.h"
...
#line 441 "/home/laxyos/basilisk/src/fractions.h"

void reconstruction (const scalar c, vector n, scalar alpha)
{ trace ("reconstruction", "/home/laxyos/basilisk/src/fractions.h", 443);
   { 
#define mycs _mycs
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/fractions.h", .line = 444,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 444 "/home/laxyos/basilisk/src/fractions.h"
 {
...
#line 476 "/home/laxyos/basilisk/src/fractions.h"
  {
#line 476
...
#line 476
 ...
 end_trace("reconstruction", "/home/laxyos/basilisk/src/fractions.h", 485); }
#line 505 "/home/laxyos/basilisk/src/fractions.h"
struct OutputFacets {
  scalar c;
  FILE * fp;
  vector s;
...
{ trace ("output_facets", "/home/laxyos/basilisk/src/fractions.h", 513);
  scalar c = p.c;
  vector s = p.s;
  if (!p.fp) p.fp = fout;
  if (!s.x.i) s.x.i = -1;
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/fractions.h", .line = 519,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 519 "/home/laxyos/basilisk/src/fractions.h"
...
#line 538 "/home/laxyos/basilisk/src/fractions.h"
    } } end_foreach_stencil();  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
#undef facet_normal
...
#line 538 "/home/laxyos/basilisk/src/fractions.h"
  ...
  fflush (p.fp);
 end_trace("output_facets", "/home/laxyos/basilisk/src/fractions.h", 541); }
...
{ trace ("interface_area", "/home/laxyos/basilisk/src/fractions.h", 551);
  double area = 0.;
   { 
#define mycs _mycs
disable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double area = _area; NOT_UNUSED(area);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/fractions.h", .line = 553,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 553 "/home/laxyos/basilisk/src/fractions.h"
...
#line 558
  ...
  { double _ret =  area; end_trace("interface_area", "/home/laxyos/basilisk/src/fractions.h", 559);  return _ret; }
 end_trace("interface_area", "/home/laxyos/basilisk/src/fractions.h", 560); }
#line 36 "/home/laxyos/basilisk/src/vof.h"
#line 44 "/home/laxyos/basilisk/src/vof.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 56 "/home/laxyos/basilisk/src/vof.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 80 "/home/laxyos/basilisk/src/vof.h"
...
static int defaults_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_1 (const int i, const double t, Event * _ev) { trace ("defaults_1", "/home/laxyos/basilisk/src/vof.h", 103); 
{
  strongif (interfaces) for (scalar c = *interfaces, *_i110 = interfaces; ((scalar *)&c)->i >= 0; c = *++_i110) {
    ...
    strongif (tracers) for (scalar t = *tracers, *_i111 = tracers; ((scalar *)&t)->i >= 0; t = *++_i111) {
 ...
 end_trace("defaults_1", "/home/laxyos/basilisk/src/vof.h", 116); } return 0; } 
...
static int defaults_2_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_2 (const int i, const double t, Event * _ev) { trace ("defaults_2", "/home/laxyos/basilisk/src/vof.h", 123); 
{
  strongif (interfaces) for (scalar c = *interfaces, *_i112 = interfaces; ((scalar *)&c)->i >= 0; c = *++_i112) {
    scalar * tracers = _attribute[c.i].tracers;
    strongif (tracers) for (scalar t = *tracers, *_i113 = tracers; ((scalar *)&t)->i >= 0; t = *++_i113)
      _attribute[t.i].depends = list_add (_attribute[t.i].depends, c);
  }
 end_trace("defaults_2", "/home/laxyos/basilisk/src/vof.h", 130); } return 0; } 





static int stability_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int stability_0 (const int i, const double t, Event * _ev) { trace ("stability_0", "/home/laxyos/basilisk/src/vof.h", 136);  {
  if (CFL > 0.5)
    CFL = 0.5;
 end_trace("stability_0", "/home/laxyos/basilisk/src/vof.h", 139); } return 0; } 
#line 153 "/home/laxyos/basilisk/src/vof.h"
...
static void sweep_x (scalar c, scalar cc, scalar * tcl)
{
  ...
  double cfl = 0.;
#line 167 "/home/laxyos/basilisk/src/vof.h"
  scalar * tracers = _attribute[c.i].tracers, * gfl = NULL, * tfluxl = NULL;
  if (tracers) {
    strongif (tracers) for (scalar t = *tracers, *_i114 = tracers; ((scalar *)&t)->i >= 0; t = *++_i114) {
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/vof.h", .line = 178,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 178 "/home/laxyos/basilisk/src/vof.h"
 {
      scalar t, gf;
...
{ double dt = _dt; NOT_UNUSED(dt);
 double cfl = _cfl; NOT_UNUSED(cfl);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/vof.h", .line = 191,
    .each = "foreach_face", .first = _first_call
  };
...
#line 191 "/home/laxyos/basilisk/src/vof.h"
 {
...
#line 221 "/home/laxyos/basilisk/src/vof.h"
    double cf;
...
#line 252
 ...
 if (dt != _dt)
   reduction_warning ("/home/laxyos/basilisk/src/vof.h", 191, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 252
  ...
  if (cfl > 0.5 + 1e-6)
    fprintf (ferr,
      ...
      cfl - 0.5), fflush (ferr);
#line 281 "/home/laxyos/basilisk/src/vof.h"
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{  double _dt = dt;
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/vof.h", .line = 281,
    .each = "foreach", .first = _first_call
  };
...
#line 281 "/home/laxyos/basilisk/src/vof.h"
 ...
 if (dt != _dt)
   reduction_warning ("/home/laxyos/basilisk/src/vof.h", 281, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 304 "/home/laxyos/basilisk/src/vof.h"
...
{
  strongif (interfaces) for (scalar c = *interfaces, *_i115 = interfaces; ((scalar *)&c)->i >= 0; c = *++_i115) {
#line 324 "/home/laxyos/basilisk/src/vof.h"
    scalar cc= new_scalar("cc"), * tcl = NULL, * tracers = _attribute[c.i].tracers;
    strongif (tracers) for (scalar t = *tracers, *_i116 = tracers; ((scalar *)&t)->i >= 0; t = *++_i116) {
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/vof.h", .line = 337,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 337 "/home/laxyos/basilisk/src/vof.h"
 {
...
static int vof_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int vof_0 (const int i, const double t, Event * _ev) { trace ("vof_0", "/home/laxyos/basilisk/src/vof.h", 363); 
  vof_advection (interfaces, i); end_trace("vof_0", "/home/laxyos/basilisk/src/vof.h", 364);  return 0; } 
#line 14 "./two-phaseVP.h"
...
static int defaults_3_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_3 (const int i, const double t, Event * _ev) { trace ("defaults_3", "./two-phaseVP.h", 27);  {
  alpha = alphav;
  rho = rhov;
 ...
 end_trace("defaults_3", "./two-phaseVP.h", 37); } return 0; } 
#line 56 "./two-phaseVP.h"
scalar sf= {15};




static int properties_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int properties_0 (const int i, const double t, Event * _ev) { trace ("properties_0", "./two-phaseVP.h", 61);  {
#line 70 "./two-phaseVP.h"
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "./two-phaseVP.h", .line = 70,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){
...
#line 70 "./two-phaseVP.h"
    ...
    _stencil_val(__FILE__,__LINE__,sf,0,0,0) = (4.*_stencil_val(__FILE__,__LINE__,f,0,0,0) +
     2.*(_stencil_val(__FILE__,__LINE__,f,0,1,0) + _stencil_val(__FILE__,__LINE__,f,0,-1,0) + _stencil_val(__FILE__,__LINE__,f,1,0,0) + _stencil_val(__FILE__,__LINE__,f,-1,0,0)) +
     _stencil_val(__FILE__,__LINE__,f,-1,-1,0) + _stencil_val(__FILE__,__LINE__,f,1,-1,0) + _stencil_val(__FILE__,__LINE__,f,1,1,0) + _stencil_val(__FILE__,__LINE__,f,-1,1,0))/16.; } end_foreach_stencil();  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
#line 73
foreach(){
...
#line 70 "./two-phaseVP.h"
    ...
    val(sf,0,0,0) = (4.*val(f,0,0,0) +
     2.*(val(f,0,1,0) + val(f,0,-1,0) + val(f,1,0,0) + val(f,-1,0,0)) +
     val(f,-1,-1,0) + val(f,1,-1,0) + val(f,1,1,0) + val(f,-1,1,0))/16.; } end_foreach(); }
#line 89 "./two-phaseVP.h"
  _attribute[sf.i].prolongation = refine_bilinear;
  boundary_internal ((scalar *)(((scalar []){sf,{-1}})), "./two-phaseVP.h", 90);
...
{ double rho1 = _rho1; NOT_UNUSED(rho1);
 ...
 double tauy = _tauy; NOT_UNUSED(tauy);
 double mumax = _mumax; NOT_UNUSED(mumax);
 double mu2 = _mu2; NOT_UNUSED(mu2);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "./two-phaseVP.h", .line = 93,
    .each = "foreach_face", .first = _first_call
  };
...
#line 93 "./two-phaseVP.h"
 {
    double ff = (_stencil_val(__FILE__,__LINE__,sf,0,0,0) + _stencil_val(__FILE__,__LINE__,sf,-1,0,0))/2.;
    _stencil_val(__FILE__,__LINE__,alphav.x,0,0,0) = val_fm_x(fm.x,0,0,0)/(clamp(ff,0.,1.)*(rho1 - rho2) + rho2);
    double muTemp = mu1;
    vector muv = mu;
    double D11 = (_stencil_val(__FILE__,__LINE__,u.x,0,0,0) - _stencil_val(__FILE__,__LINE__,u.x,-1,0,0));
    double D22 = ((_stencil_val(__FILE__,__LINE__,u.y,0,1,0)-_stencil_val(__FILE__,__LINE__,u.y,0,-1,0))+(_stencil_val(__FILE__,__LINE__,u.y,-1,1,0)-_stencil_val(__FILE__,__LINE__,u.y,-1,-1,0)))/4.0;
    double D12 = 0.5*(((_stencil_val(__FILE__,__LINE__,u.x,0,1,0)-_stencil_val(__FILE__,__LINE__,u.x,0,-1,0))+(_stencil_val(__FILE__,__LINE__,u.x,-1,1,0)-_stencil_val(__FILE__,__LINE__,u.x,-1,-1,0)))/4.0 + (_stencil_val(__FILE__,__LINE__,u.y,0,0,0) - _stencil_val(__FILE__,__LINE__,u.y,-1,0,0)));
    ...
    _stencil_val(__FILE__,__LINE__,muv.x,0,0,0) = val_fm_x(fm.x,0,0,0)*(clamp(ff,0.,1.)*(muTemp - mu2) + mu2);
    _stencil_val(__FILE__,__LINE__,D2f.x,0,0,0) = D2;
  } }  }}  end_foreach_face_stencil()
#line 114
 }
strongif (is_constant(fm.x)) {
...
#line 114
 ...
 if (rho1 != _rho1)
   reduction_warning ("./two-phaseVP.h", 93, "rho1");
 }
 if (_first_call) {
 if (rho2 != _rho2)
   reduction_warning ("./two-phaseVP.h", 93, "rho2");
 }
 if (_first_call) {
 if (mu1 != _mu1)
   reduction_warning ("./two-phaseVP.h", 93, "mu1");
 }
 if (_first_call) {
 if (tauy != _tauy)
   reduction_warning ("./two-phaseVP.h", 93, "tauy");
 }
 if (_first_call) {
 if (mumax != _mumax)
   reduction_warning ("./two-phaseVP.h", 93, "mumax");
 }
 if (_first_call) {
 if (mu2 != _mu2)
   reduction_warning ("./two-phaseVP.h", 93, "mu2");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 93 "./two-phaseVP.h"
 {
    double ff = (val(sf,0,0,0) + val(sf,-1,0,0))/2.;
    val(alphav.x,0,0,0) = val_fm_x(fm.x,0,0,0)/(clamp(ff,0.,1.)*(rho1 - rho2) + rho2);
    double muTemp = mu1;
    vector muv = mu;
    double D11 = (val(u.x,0,0,0) - val(u.x,-1,0,0));
    double D22 = ((val(u.y,0,1,0)-val(u.y,0,-1,0))+(val(u.y,-1,1,0)-val(u.y,-1,-1,0)))/4.0;
    double D12 = 0.5*(((val(u.x,0,1,0)-val(u.x,0,-1,0))+(val(u.x,-1,1,0)-val(u.x,-1,-1,0)))/4.0 + (val(u.y,0,0,0) - val(u.y,-1,0,0)));
    double D2 = sqrt(sq(D11)+sq(D22)+2.0*sq(D12))/(Delta);
    if (D2 > 0. && tauy > 0.){
      double temp = tauy/(sqrt(2.)*D2) + mu1;
      muTemp = min(temp, mumax);
    ...
    val(muv.x,0,0,0) = val_fm_x(fm.x,0,0,0)*(clamp(ff,0.,1.)*(muTemp - mu2) + mu2);
    val(D2f.x,0,0,0) = D2;
  } }  }}  end_foreach_face_generic()
#line 114
 end_foreach_face(); }
...
#line 116 "./two-phaseVP.h"
 {
    double ff = (_stencil_val(__FILE__,__LINE__,sf,0,0,0) + _stencil_val(__FILE__,__LINE__,sf,0,-1,0))/2.;
    _stencil_val(__FILE__,__LINE__,alphav.y,0,0,0) = val_fm_y(fm.y,0,0,0)/(clamp(ff,0.,1.)*(rho1 - rho2) + rho2);
    double muTemp = mu1;
    vector muv = mu;
    double D11 = (_stencil_val(__FILE__,__LINE__,u.y,0,0,0) - _stencil_val(__FILE__,__LINE__,u.y,0,-1,0))/Delta;
    double D22 = 0.5*( (_stencil_val(__FILE__,__LINE__,u.x,1,0,0) - _stencil_val(__FILE__,__LINE__,u.x,-1,0,0) + _stencil_val(__FILE__,__LINE__,u.x,1,-1,0) - _stencil_val(__FILE__,__LINE__,u.x,-1,-1,0))/(2.*Delta) );
    double D12 = 0.5*( (_stencil_val(__FILE__,__LINE__,u.x,0,0,0) - _stencil_val(__FILE__,__LINE__,u.x,0,-1,0))/Delta + 0.5*( (_stencil_val(__FILE__,__LINE__,u.y,1,0,0) - _stencil_val(__FILE__,__LINE__,u.y,-1,0,0) + _stencil_val(__FILE__,__LINE__,u.y,1,-1,0) - _stencil_val(__FILE__,__LINE__,u.y,-1,-1,0))/(2.*Delta) ) );
    ...
    _stencil_val(__FILE__,__LINE__,muv.y,0,0,0) = val_fm_y(fm.y,0,0,0)*(clamp(ff,0.,1.)*(muTemp - mu2) + mu2);
    _stencil_val(__FILE__,__LINE__,D2f.y,0,0,0) = D2;
  } }  }}  end_foreach_face_stencil()
#line 138
 }
strongif (is_constant(fm.x)) {
...
#line 138
 ...
 if (rho1 != _rho1)
   reduction_warning ("./two-phaseVP.h", 116, "rho1");
 }
 if (_first_call) {
 if (rho2 != _rho2)
   reduction_warning ("./two-phaseVP.h", 116, "rho2");
 }
 if (_first_call) {
 if (mu1 != _mu1)
   reduction_warning ("./two-phaseVP.h", 116, "mu1");
 }
 if (_first_call) {
 if (tauy != _tauy)
   reduction_warning ("./two-phaseVP.h", 116, "tauy");
 }
 if (_first_call) {
 if (mumax != _mumax)
   reduction_warning ("./two-phaseVP.h", 116, "mumax");
 }
 if (_first_call) {
 if (mu2 != _mu2)
   reduction_warning ("./two-phaseVP.h", 116, "mu2");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 116 "./two-phaseVP.h"
 {
    double ff = (val(sf,0,0,0) + val(sf,0,-1,0))/2.;
    val(alphav.y,0,0,0) = val_fm_y(fm.y,0,0,0)/(clamp(ff,0.,1.)*(rho1 - rho2) + rho2);
    double muTemp = mu1;
    vector muv = mu;
    double D11 = (val(u.y,0,0,0) - val(u.y,0,-1,0))/Delta;
    double D22 = 0.5*( (val(u.x,1,0,0) - val(u.x,-1,0,0) + val(u.x,1,-1,0) - val(u.x,-1,-1,0))/(2.*Delta) );
    double D12 = 0.5*( (val(u.x,0,0,0) - val(u.x,0,-1,0))/Delta + 0.5*( (val(u.y,1,0,0) - val(u.y,-1,0,0) + val(u.y,1,-1,0) - val(u.y,-1,-1,0))/(2.*Delta) ) );
    ...
    val(muv.y,0,0,0) = val_fm_y(fm.y,0,0,0)*(clamp(ff,0.,1.)*(muTemp - mu2) + mu2);
    val(D2f.y,0,0,0) = D2;
  } }  }}  end_foreach_face_generic()
#line 138
 end_foreach_face(); }
...
#line 140 "./two-phaseVP.h"
{
    _stencil_val(__FILE__,__LINE__,rhov,0,0,0) = val_cm(cm,0,0,0)*(clamp(_stencil_val(__FILE__,__LINE__,sf,0,0,0),0.,1.)*(rho1 - rho2) + rho2);
    _stencil_val(__FILE__,__LINE__,D2,0,0,0) = (_stencil_val(__FILE__,__LINE__,D2f.x,0,0,0)+_stencil_val(__FILE__,__LINE__,D2f.y,0,0,0)+_stencil_val(__FILE__,__LINE__,D2f.x,1,0,0)+_stencil_val(__FILE__,__LINE__,D2f.y,0,1,0))/4.;
    IF (_stencil_val(__FILE__,__LINE__,D2,0,0,0) > 0.){
      _stencil_val(__FILE__,__LINE__,D2,0,0,0) = log(_stencil_val(__FILE__,__LINE__,D2,0,0,0))/log(10);
    }  {
      _stencil_val(__FILE__,__LINE__,D2,0,0,0) = -10;
    }
  } } end_foreach_stencil(); }
strongif (is_constant(cm)) {
const double _const_cm = _constant[cm.i -_NVARMAX];
...
#line 140 "./two-phaseVP.h"
{
 ...
 if (rho1 != _rho1)
   reduction_warning ("./two-phaseVP.h", 140, "rho1");
 }
 if (_first_call) {
 if (rho2 != _rho2)
   reduction_warning ("./two-phaseVP.h", 140, "rho2");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 140 "./two-phaseVP.h"
{
    val(rhov,0,0,0) = val_cm(cm,0,0,0)*(clamp(val(sf,0,0,0),0.,1.)*(rho1 - rho2) + rho2);
    val(D2,0,0,0) = (val(D2f.x,0,0,0)+val(D2f.y,0,0,0)+val(D2f.x,1,0,0)+val(D2f.y,0,1,0))/4.;
    if (val(D2,0,0,0) > 0.){
      val(D2,0,0,0) = log(val(D2,0,0,0))/log(10);
    } else {
      val(D2,0,0,0) = -10;
    }
  } } end_foreach(); }
...
#line 140 "./two-phaseVP.h"
{
  ...
  boundary_internal ((scalar *)(all), "./two-phaseVP.h", 149);

  _attribute[sf.i].prolongation = fraction_refine;
  boundary_internal ((scalar *)(((scalar []){sf,{-1}})), "./two-phaseVP.h", 152);

 end_trace("properties_0", "./two-phaseVP.h", 154); } return 0; } 
#line 11 "shear_square.c"
#line 1 "navier-stokes/conserving.h"
#line 1 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"
#line 14 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"
...
#define _IN_STENCIL 1
#define refine_bilinear _refine_bilinear

#line 14
static void _momentum_refine (Point point, scalar u) { int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 14 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"
...
#line 14
  ...
  double rhou = 0.;
   { foreach_child()
    rhou += val_cm(cm,0,0,0)*(clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.)*(rho1 - rho2) + rho2)*_stencil_val(__FILE__,__LINE__,u,0,0,0); end_foreach_child(); }
  double du = _stencil_val(__FILE__,__LINE__,u,0,0,0) - rhou/((1 << 2)*val_cm(cm,0,0,0)*(clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.)*(rho1 - rho2) + rho2));
   { foreach_child()
    _stencil_val(__FILE__,__LINE__,u,0,0,0) += du; end_foreach_child(); }
 }
strongif (is_constant(cm)) {
const double _const_cm = _constant[cm.i -_NVARMAX];
NOT_UNUSED(_const_cm);
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 25 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"
...
#if _call_momentum_restriction
}
#define _IN_STENCIL 1

#line 24
static void _momentum_restriction (Point point, scalar u)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 25 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"
...
#line 25
  ...
  double rhou = 0.;
   { foreach_child()
    rhou += val_cm(cm,0,0,0)*(clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.)*(rho1 - rho2) + rho2)*_stencil_val(__FILE__,__LINE__,u,0,0,0); end_foreach_child(); }
  _stencil_val(__FILE__,__LINE__,u,0,0,0) = rhou/((1 << 2)*val_cm(cm,0,0,0)*(clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.)*(rho1 - rho2) + rho2));
 }
strongif (is_constant(cm)) {
const double _const_cm = _constant[cm.i -_NVARMAX];
NOT_UNUSED(_const_cm);
...
static int defaults_4_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_4 (const int i, const double t, Event * _ev) { trace ("defaults_4", "/home/laxyos/basilisk/src/navier-stokes/conserving.h", 37); 
{
  stokes = true;
#line 49 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"
  int i = 0;
  while (all[i].i != f.i) i++;
  while (i > 0 && all[i].i)
    all[i] = all[i-1], i--;
...
#line 60
 {
    ...
    _attribute[u.x.i].depends = list_add (_attribute[u.x.i].depends, f);
  }
#line 60
 {
    _attribute[u.y.i].refine = _attribute[u.y.i].prolongation = momentum_refine;
    _attribute[u.y.i].restriction = momentum_restriction;
    _attribute[u.y.i].depends = list_add (_attribute[u.y.i].depends, f);
  }}

 end_trace("defaults_4", "/home/laxyos/basilisk/src/navier-stokes/conserving.h", 66); } return 0; } 





static int stability_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int stability_1 (const int i, const double t, Event * _ev) { trace ("stability_1", "/home/laxyos/basilisk/src/navier-stokes/conserving.h", 72); 
  dtmax = timestep (uf, dtmax); end_trace("stability_1", "/home/laxyos/basilisk/src/navier-stokes/conserving.h", 73);  return 0; } 
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 83 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

  return clamp(val(f,0,0,0),0.,1.)*rho1*val(u.x,0,0,0);

#if _call_boundary_q1_x
}
#define _IN_STENCIL 1

#line 82
static double _boundary_q1_x (Point neighbor, Point point, scalar q1, void * data)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 83 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

  return clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.)*rho1*_stencil_val(__FILE__,__LINE__,u.x,0,0,0);
...
static double boundary_q1_y (Point neighbor, Point point, scalar q1, void * data)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 83 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

  return clamp(val(f,0,0,0),0.,1.)*rho1*val(u.y,0,0,0);

#if _call_boundary_q1_y
}
#define _IN_STENCIL 1

#line 82
static double _boundary_q1_y (Point neighbor, Point point, scalar q1, void * data)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 83 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

  return clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.)*rho1*_stencil_val(__FILE__,__LINE__,u.y,0,0,0);
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 89 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

  return (1. - clamp(val(f,0,0,0),0.,1.))*rho2*val(u.x,0,0,0);

#if _call_boundary_q2_x
}
#define _IN_STENCIL 1

#line 88
static double _boundary_q2_x (Point neighbor, Point point, scalar q2, void * data)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 89 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

  return (1. - clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.))*rho2*_stencil_val(__FILE__,__LINE__,u.x,0,0,0);
...
static double boundary_q2_y (Point neighbor, Point point, scalar q2, void * data)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 89 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

  return (1. - clamp(val(f,0,0,0),0.,1.))*rho2*val(u.y,0,0,0);

#if _call_boundary_q2_y
}
#define _IN_STENCIL 1

#line 88
static double _boundary_q2_y (Point neighbor, Point point, scalar q2, void * data)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 89 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

  return (1. - clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.))*rho2*_stencil_val(__FILE__,__LINE__,u.y,0,0,0);
...
#line 99 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

   { foreach_child()
    val(q1,0,0,0) = clamp(val(f,0,0,0),0.,1.)*rho1*val(u.x,0,0,0); end_foreach_child(); }

#if _call_prolongation_q1_x
}
#define _IN_STENCIL 1

#line 99
static void _prolongation_q1_x (Point point, scalar q1) { int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 99 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

   { foreach_child()
    _stencil_val(__FILE__,__LINE__,q1,0,0,0) = clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.)*rho1*_stencil_val(__FILE__,__LINE__,u.x,0,0,0); end_foreach_child(); }
...
#if _call_prolongation_q1_y
}
#define _IN_STENCIL 1

#line 99
static void _prolongation_q1_y (Point point, scalar q1) { int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 99 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

   { foreach_child()
    _stencil_val(__FILE__,__LINE__,q1,0,0,0) = clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.)*rho1*_stencil_val(__FILE__,__LINE__,u.y,0,0,0); end_foreach_child(); }
...
#line 105 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

   { foreach_child()
    val(q2,0,0,0) = (1. - clamp(val(f,0,0,0),0.,1.))*rho2*val(u.x,0,0,0); end_foreach_child(); }

#if _call_prolongation_q2_x
}
#define _IN_STENCIL 1

#line 105
static void _prolongation_q2_x (Point point, scalar q2) { int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 105 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

   { foreach_child()
    _stencil_val(__FILE__,__LINE__,q2,0,0,0) = (1. - clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.))*rho2*_stencil_val(__FILE__,__LINE__,u.x,0,0,0); end_foreach_child(); }
...
#if _call_prolongation_q2_y
}
#define _IN_STENCIL 1

#line 105
static void _prolongation_q2_y (Point point, scalar q2) { int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 105 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

   { foreach_child()
    _stencil_val(__FILE__,__LINE__,q2,0,0,0) = (1. - clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.))*rho2*_stencil_val(__FILE__,__LINE__,u.y,0,0,0); end_foreach_child(); }
...
static int vof_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int vof_1 (const int i, const double t, Event * _ev) { trace ("vof_1", "/home/laxyos/basilisk/src/navier-stokes/conserving.h", 117);  {
  ...
  for (scalar s = *((scalar []){q1.x,q1.y,q2.x,q2.y,{-1}}), *_i117 = ((scalar []){q1.x,q1.y,q2.x,q2.y,{-1}}); ((scalar *)&s)->i >= 0; s = *++_i117) {
...
{ double rho1 = _rho1; NOT_UNUSED(rho1);
 double rho2 = _rho2; NOT_UNUSED(rho2);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/conserving.h", .line = 147,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 147 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

    {
#line 148
 {
      double fc = clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0,1);
      _stencil_val(__FILE__,__LINE__,q1.x,0,0,0) = fc*rho1*_stencil_val(__FILE__,__LINE__,u.x,0,0,0);
      _stencil_val(__FILE__,__LINE__,q2.x,0,0,0) = (1. - fc)*rho2*_stencil_val(__FILE__,__LINE__,u.x,0,0,0);
    }
#line 148
 {
      double fc = clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0,1);
      _stencil_val(__FILE__,__LINE__,q1.y,0,0,0) = fc*rho1*_stencil_val(__FILE__,__LINE__,u.y,0,0,0);
      _stencil_val(__FILE__,__LINE__,q2.y,0,0,0) = (1. - fc)*rho2*_stencil_val(__FILE__,__LINE__,u.y,0,0,0);
    }} } end_foreach_stencil(); if (_first_call) {
 if (rho1 != _rho1)
   reduction_warning ("/home/laxyos/basilisk/src/navier-stokes/conserving.h", 147, "rho1");
 }
 if (_first_call) {
 if (rho2 != _rho2)
   reduction_warning ("/home/laxyos/basilisk/src/navier-stokes/conserving.h", 147, "rho2");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 159
 {
  ...
  _attribute[f.i].tracers = list_concat (tracers, (scalar *)((vector []){{q1.x,q1.y},{q2.x,q2.y},{{-1},{-1}}}));
...
{ double rho1 = _rho1; NOT_UNUSED(rho1);
 double rho2 = _rho2; NOT_UNUSED(rho2);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/navier-stokes/conserving.h", .line = 178,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 178 "/home/laxyos/basilisk/src/navier-stokes/conserving.h"

    {
#line 179

      _stencil_val(__FILE__,__LINE__,u.x,0,0,0) = (_stencil_val(__FILE__,__LINE__,q1.x,0,0,0) + _stencil_val(__FILE__,__LINE__,q2.x,0,0,0))/(clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.)*(rho1 - rho2) + rho2);
#line 179

      _stencil_val(__FILE__,__LINE__,u.y,0,0,0) = (_stencil_val(__FILE__,__LINE__,q1.y,0,0,0) + _stencil_val(__FILE__,__LINE__,q2.y,0,0,0))/(clamp(_stencil_val(__FILE__,__LINE__,f,0,0,0),0.,1.)*(rho1 - rho2) + rho2);}; } end_foreach_stencil(); if (_first_call) {
 if (rho1 != _rho1)
   reduction_warning ("/home/laxyos/basilisk/src/navier-stokes/conserving.h", 178, "rho1");
 }
 if (_first_call) {
 if (rho2 != _rho2)
   reduction_warning ("/home/laxyos/basilisk/src/navier-stokes/conserving.h", 178, "rho2");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 179
 ...
 delete (((scalar []){q2.x,q2.y,q1.x,q1.y,{-1}}));  end_trace("vof_1", "/home/laxyos/basilisk/src/navier-stokes/conserving.h", 187); } return 0; } 




static int tracer_advection_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int tracer_advection_0 (const int i, const double t, Event * _ev) { trace ("tracer_advection_0", "/home/laxyos/basilisk/src/navier-stokes/conserving.h", 192);  {
  interfaces = interfaces1;
 end_trace("tracer_advection_0", "/home/laxyos/basilisk/src/navier-stokes/conserving.h", 194); } return 0; } 
#line 12 "shear_square.c"
#line 1 "tension.h"
#line 1 "/home/laxyos/basilisk/src/tension.h"
#line 15 "/home/laxyos/basilisk/src/tension.h"
#line 1 "iforce.h"
#line 1 "/home/laxyos/basilisk/src/iforce.h"
#line 20 "/home/laxyos/basilisk/src/iforce.h"
...
static int defaults_5_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_5 (const int i, const double t, Event * _ev) { trace ("defaults_5", "/home/laxyos/basilisk/src/iforce.h", 30);  {
  if (is_constant(a.x)) {
    a = new_face_vector("a");
     { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/iforce.h", .line = 33,
    .each = "foreach_face", .first = _first_call
  };
foreach_face_stencil() { int ig = -1; VARIABLES;  strongif (is_stencil_face_x()) {
#line 33
...
#line 33 "/home/laxyos/basilisk/src/iforce.h"
...
#line 34
 ...
 end_trace("defaults_5", "/home/laxyos/basilisk/src/iforce.h", 36); } return 0; } 
...
static int acceleration_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration_0 (const int i, const double t, Event * _ev) { trace ("acceleration_0", "/home/laxyos/basilisk/src/iforce.h", 43); 
{
  ...
  scalar * list = NULL;
  strongif (interfaces) for (scalar f = *interfaces, *_i118 = interfaces; ((scalar *)&f)->i >= 0; f = *++_i118)
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/iforce.h", .line = 60,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 60 "/home/laxyos/basilisk/src/iforce.h"
...
#line 72 "/home/laxyos/basilisk/src/iforce.h"
  strongif (list) for (scalar f = *list, *_i119 = list; ((scalar *)&f)->i >= 0; f = *++_i119) {
    _attribute[f.i].prolongation = _attribute[p.i].prolongation;
    _attribute[f.i].dirty = true;
  }
#line 86 "/home/laxyos/basilisk/src/iforce.h"
  vector ia = a;
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/iforce.h", .line = 87,
    .each = "foreach_face", .first = _first_call
  };
...
#line 87 "/home/laxyos/basilisk/src/iforce.h"

    strongif (list) for (scalar f = *list, *_i120 = list; ((scalar *)&f)->i >= 0; f = *++_i120)
      IF (_stencil_val(__FILE__,__LINE__,f,0,0,0) != _stencil_val(__FILE__,__LINE__,f,-1,0,0) && val_fm_x(fm.x,0,0,0) > 0.) {
#line 99 "/home/laxyos/basilisk/src/iforce.h"
...
#line 108
 end_foreach_face(); } }
  ...
  strongif (list) for (scalar f = *list, *_i121 = list; ((scalar *)&f)->i >= 0; f = *++_i121) {
  ...
  strongif (list) for (scalar f = *list, *_i122 = list; ((scalar *)&f)->i >= 0; f = *++_i122) {
    scalar phi = _attribute[f.i].phi;
    delete (((scalar []){phi,{-1}}));
    _attribute[f.i].phi.i = 0;
  }
  pfree (list,__func__,__FILE__,__LINE__);
 end_trace("acceleration_0", "/home/laxyos/basilisk/src/iforce.h", 131); } return 0; } 
#line 16 "/home/laxyos/basilisk/src/tension.h"
#line 1 "curvature.h"
#line 1 "/home/laxyos/basilisk/src/curvature.h"
#line 12 "/home/laxyos/basilisk/src/curvature.h"
static void curvature_restriction (Point point, scalar kappa)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 13 "/home/laxyos/basilisk/src/curvature.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 28 "/home/laxyos/basilisk/src/curvature.h"
...
#line 66 "/home/laxyos/basilisk/src/curvature.h"
#line 1 "heights.h"
#line 1 "/home/laxyos/basilisk/src/heights.h"
#line 29 "/home/laxyos/basilisk/src/heights.h"
...
#line 49 "/home/laxyos/basilisk/src/heights.h"
static void half_column (Point point, scalar c, vector h, vector cs, int j)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 50 "/home/laxyos/basilisk/src/heights.h"
...
#line 109 "/home/laxyos/basilisk/src/heights.h"
    for (int i = 1; i <= 4; i++) {
...
#line 138 "/home/laxyos/basilisk/src/heights.h"
      else if (S >= 1. && ci <= 0.) {
 H = (H - 0.5)*j + (j == -1)*20.;
 S = complete;
 break;
...
#line 156 "/home/laxyos/basilisk/src/heights.h"
...
#line 195 "/home/laxyos/basilisk/src/heights.h"
      if (state.s != complete ||
...
#line 222 "/home/laxyos/basilisk/src/heights.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/heights.h", .line = 224,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 224 "/home/laxyos/basilisk/src/heights.h"
...
#line 288 "/home/laxyos/basilisk/src/heights.h"

#line 288

static void refine_h_x (Point point, scalar h)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 290 "/home/laxyos/basilisk/src/heights.h"
 ...
 val(h,0,0,0) = val(h,i,0,0) + i;
  ...
  if (complete)
    return;
#line 316 "/home/laxyos/basilisk/src/heights.h"
...
#line 351 "/home/laxyos/basilisk/src/heights.h"
...
{ trace ("heights", "/home/laxyos/basilisk/src/heights.h", 360);
...
#line 377 "/home/laxyos/basilisk/src/heights.h"
...
#line 386 "/home/laxyos/basilisk/src/heights.h"
...
#line 398 "/home/laxyos/basilisk/src/heights.h"
       { foreach_level (l - 1){
...
#line 409 "/home/laxyos/basilisk/src/heights.h"
...
#line 418 "/home/laxyos/basilisk/src/heights.h"
...
#line 444
 ...
 delete (((scalar []){s.x,s.y,{-1}}));  end_trace("heights", "/home/laxyos/basilisk/src/heights.h", 446); }
...
#line 67 "/home/laxyos/basilisk/src/curvature.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 71 "/home/laxyos/basilisk/src/curvature.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 83 "/home/laxyos/basilisk/src/curvature.h"
...
#line 179 "/home/laxyos/basilisk/src/curvature.h"
static double height_curvature (Point point, scalar c, vector h)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 180 "/home/laxyos/basilisk/src/curvature.h"
...
#line 211 "/home/laxyos/basilisk/src/curvature.h"
  double kappa = nodata;
  {
#line 212
...
#line 247 "/home/laxyos/basilisk/src/curvature.h"
  }
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 258 "/home/laxyos/basilisk/src/curvature.h"
...
#line 288 "/home/laxyos/basilisk/src/curvature.h"
...
#line 330 "/home/laxyos/basilisk/src/curvature.h"
#line 1 "parabola.h"
#line 1 "/home/laxyos/basilisk/src/parabola.h"
#line 1 "utils.h"
#line 2 "/home/laxyos/basilisk/src/parabola.h"
...
typedef struct {
  ...
  coord m;
  double ** M, rhs[3], a[3];
#line 21 "/home/laxyos/basilisk/src/parabola.h"
} ParabolaFit;
...
#line 28
  ...
  normalize (&p->m);
  int n = 3;
#line 65 "/home/laxyos/basilisk/src/parabola.h"
...
#line 111 "/home/laxyos/basilisk/src/parabola.h"
}
...
static double parabola_fit_solve (ParabolaFit * p)
{
  ...
  if (pivmin) {
    ...
    p->a[0] = p->a[1] = 0.;
#line 158 "/home/laxyos/basilisk/src/parabola.h"
  matrix_free (p->M);
  return pivmin;
}
          ...
          double kappamax, double * kmax)
{
  ...
  if (kmax)
    *kmax = fabs (kappa);
#line 190 "/home/laxyos/basilisk/src/parabola.h"
...
#line 331 "/home/laxyos/basilisk/src/curvature.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 361 "/home/laxyos/basilisk/src/curvature.h"
...
#line 438 "/home/laxyos/basilisk/src/curvature.h"
  for (int i = 0; i < n; i++)
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 454 "/home/laxyos/basilisk/src/curvature.h"
...
#line 500 "/home/laxyos/basilisk/src/curvature.h"
static inline bool interfacial (Point point, scalar c)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 501 "/home/laxyos/basilisk/src/curvature.h"
...
#line 530 "/home/laxyos/basilisk/src/curvature.h"
typedef struct {
  int h;
  int f;
  int a;
...
{ trace ("curvature", "/home/laxyos/basilisk/src/curvature.h", 545);
...
{ int sh = _sh; NOT_UNUSED(sh);
 int sf = _sf; NOT_UNUSED(sf);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/curvature.h", .line = 569,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 569 "/home/laxyos/basilisk/src/curvature.h"
 {
...
{ double sigma = _sigma; NOT_UNUSED(sigma);
 ...
 int sc = _sc; NOT_UNUSED(sc);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/curvature.h", .line = 587,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 587 "/home/laxyos/basilisk/src/curvature.h"
 {
 ...
 if (sigma != _sigma)
   reduction_warning ("/home/laxyos/basilisk/src/curvature.h", 587, "sigma");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 627
  ...
  { cstats _ret =  (cstats){sh, sf, sa, sc}; delete (((scalar []){k,{-1}}));  { strongif (!(ch).x.i) delete (((scalar []){h.x,h.y,{-1}})); }  end_trace("curvature", "/home/laxyos/basilisk/src/curvature.h", 629);  return _ret; }
 delete (((scalar []){k,{-1}}));  { strongif (!(ch).x.i) delete (((scalar []){h.x,h.y,{-1}})); }  end_trace("curvature", "/home/laxyos/basilisk/src/curvature.h", 630); }
#line 649 "/home/laxyos/basilisk/src/curvature.h"

#line 649

static double pos_x (Point point, vector h, coord * G, coord * Z)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 651 "/home/laxyos/basilisk/src/curvature.h"
...
static double height_position (Point point, scalar f, vector h,
          coord * G, coord * Z)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 670 "/home/laxyos/basilisk/src/curvature.h"
...
#line 717 "/home/laxyos/basilisk/src/curvature.h"
struct Position {
  scalar f, pos;
  coord G, Z;
  bool add;
...
{ coord * G = _G; NOT_UNUSED(G);
 coord * Z = _Z; NOT_UNUSED(Z);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/curvature.h", .line = 740,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 740 "/home/laxyos/basilisk/src/curvature.h"
 {
...
#line 753
 ...
 for (int i = 0; i < (10*sizeof(coord)); i++)
   if (((char *)_G)[i] != 0) {
     reduction_warning ("/home/laxyos/basilisk/src/curvature.h", 740, "G");
     break; }
 }
 if (_first_call) {
 for (int i = 0; i < (10*sizeof(coord)); i++)
   if (((char *)_Z)[i] != 0) {
     reduction_warning ("/home/laxyos/basilisk/src/curvature.h", 740, "Z");
     break; }
 }
  _first_call = false;
}}
...
#line 17 "/home/laxyos/basilisk/src/tension.h"
...
#line 36 "/home/laxyos/basilisk/src/tension.h"
static int stability_2_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int stability_2 (const int i, const double t, Event * _ev) { trace ("stability_2", "/home/laxyos/basilisk/src/tension.h", 36); 
{
...
{ double amin = _amin; NOT_UNUSED(amin);
 ...
 double dmin = _dmin; NOT_UNUSED(dmin);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home/laxyos/basilisk/src/tension.h", .line = 44,
    .each = "foreach_face", .first = _first_call
  };
...
#line 44 "/home/laxyos/basilisk/src/tension.h"
...
#line 49
 ...
 end_trace("stability_2", "/home/laxyos/basilisk/src/tension.h", 64); } return 0; } 
...
static int acceleration_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration_1 (const int i, const double t, Event * _ev) { trace ("acceleration_1", "/home/laxyos/basilisk/src/tension.h", 72); 
{




  strongif (interfaces) for (scalar f = *interfaces, *_i124 = interfaces; ((scalar *)&f)->i >= 0; f = *++_i124)
 ...
 end_trace("acceleration_1", "/home/laxyos/basilisk/src/tension.h", 94); } return 0; } 
#line 13 "shear_square.c"
#line 30 "shear_square.c"
static void _set_boundary4 (void) { _attribute[u.y.i].boundary[top] = _boundary4; _attribute[u.y.i].boundary_homogeneous[top] = _boundary4_homogeneous; _attribute[u.y.i].dirty = true; } 
static void _set_boundary5 (void) { _attribute[u.y.i].boundary[bottom] = _boundary5; _attribute[u.y.i].boundary_homogeneous[bottom] = _boundary5_homogeneous; _attribute[u.y.i].dirty = true; } 

int MAXlevel;
double Bi, Re, Ca, tmax;
char nameOut[80], dumpFile[80];

int main (int argc, char const *argv[]) { _init_solver();
  L0 = 5.0;
  ...
  rho1 = Re, rho2 = 1.0*Re;
  mu1 = 1., mu2 = 1.0;
  _attribute[f.i].sigma = 1./Ca;

  run();
 free_solver(); }

static int init_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 0);   *ip = i; *tp = t;   return ret; } static int init_0 (const int i, const double t, Event * _ev) { trace ("init_0", "shear_square.c", 70);  {
  if (!restore ((struct Dump){.file = dumpFile})){
    do { scalar phi= new_vertex_scalar("phi");  { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "shear_square.c", .line = 72,
    .each = "foreach_vertex", .first = _first_call
  };
foreach_vertex_stencil(){

#line 72 "shear_square.c"
 _stencil_val(__FILE__,__LINE__,phi,0,0,0) = max (- (sq(x - 0.5 - 0.5) + sq(y-0.2) - sq(0.5)),- (sq(x + 0.5 + 0.5) + sq(y+0.2) - sq(0.5))); } end_foreach_vertex_stencil();  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
#line 72
foreach_vertex(){
...
#line 72 "shear_square.c"
 val(phi,0,0,0) = max (- (sq(x - 0.5 - 0.5) + sq(y-0.2) - sq(0.5)),- (sq(x + 0.5 + 0.5) + sq(y+0.2) - sq(0.5))); } end_foreach_vertex(); } fractions ((struct Fractions){phi, f});  delete (((scalar []){phi,{-1}})); } while(0);

     { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "shear_square.c", .line = 74,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 74 "shear_square.c"
{
      _stencil_val(__FILE__,__LINE__,u.x,0,0,0) = (2*y/5.0);
    } } end_foreach_stencil();  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
#line 76
...
#line 74 "shear_square.c"
{
      val(u.x,0,0,0) = (2*y/5.0);
    } } end_foreach(); }
  }
 end_trace("init_0", "shear_square.c", 78); } return 0; } 

scalar omega= {16};
static int adapt_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int adapt_0 (const int i, const double t, Event * _ev) { trace ("adapt_0", "shear_square.c", 81); 
{
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "shear_square.c", .line = 86,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 86 "shear_square.c"
{
    _stencil_val(__FILE__,__LINE__,omega,0,0,0) *= _stencil_val(__FILE__,__LINE__,f,0,0,0);
  } } end_foreach_stencil();  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
#line 88
...
#line 86 "shear_square.c"
{
    val(omega,0,0,0) *= val(f,0,0,0);
  } } end_foreach(); }
  boundary_internal ((scalar *)((scalar *)((scalar []){KAPPA,omega,{-1}})), "shear_square.c", 89);
  adapt_wavelet((struct Adapt){(scalar *)((scalar []){f,u.x,u.y,KAPPA,omega,{-1}}),
  (double[]){(1e-3), (5e-3), (5e-3), (1e-6), (1e-2)},
  MAXlevel});
 delete (((scalar []){KAPPA,{-1}}));  end_trace("adapt_0", "shear_square.c", 93); } return 0; } 


static int writingFiles_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 0);   *ip = i; *tp = t;   return ret; } static int writingFiles_expr1 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = ( t += (0.05));   *ip = i; *tp = t;   return ret; } static int writingFiles_expr2 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = ( t <= tmax);   *ip = i; *tp = t;   return ret; } static int writingFiles (const int i, const double t, Event * _ev) { trace ("writingFiles", "shear_square.c", 96);  {
  dump ((struct Dump){.file = dumpFile});
  sprintf (nameOut, "intermediate/snapshot-%5.4f", t);
  dump((struct Dump){.file=nameOut});
 end_trace("writingFiles", "shear_square.c", 100); } return 0; } 

static int end_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 1234567890);   *ip = i; *tp = t;   return ret; } static int end (const int i, const double t, Event * _ev) { trace ("end", "shear_square.c", 102);  {
  fprintf(ferr, "Done: Level %d, Bi %2.1e, Re %4.3f, Ca %4.3f tmax %g\n", MAXlevel, Bi, Re, Ca, tmax);
 end_trace("end", "shear_square.c", 104); } return 0; } 

static int logWriting_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int logWriting (const int i, const double t, Event * _ev) { trace ("logWriting", "shear_square.c", 106);  {
  double ke = 0.;
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{  double _ke = ke;
...
{
    ke += (0.5*(sq(_stencil_val(__FILE__,__LINE__,u.x,0,0,0)) + sq(_stencil_val(__FILE__,__LINE__,u.y,0,0,0))))*sq(Delta);
  } } end_foreach_stencil();  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
#line 110
...
#line 110
 ...
 end_trace("logWriting", "shear_square.c", 124); } return 0; } 
#line 91 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 90 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 92 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 100 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 101
return  neumann_homogeneous(); } return 0.; }
#line 102 "/home/laxyos/basilisk/src/navier-stokes/centered.h"
...
#line 29 "shear_square.c"
return  dirichlet(1.); return 0.; } static double _boundary4_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  strongif (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  strongif (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 29 "shear_square.c"
return  dirichlet_homogeneous(); return 0.; }
#line 31 "shear_square.c"
...
#line 30 "shear_square.c"
return  dirichlet(-1.); return 0.; } static double _boundary5_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  strongif (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  strongif (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 30 "shear_square.c"
return  dirichlet_homogeneous(); return 0.; }
